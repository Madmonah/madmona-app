...
## خطة الحملات
- **الإيقاع:** **رسالة كل يوم** (محمد ١٣/٩: «كل يوم مش كل أسبوع — كل أسبوع الناس هتنسى») ١٠ ص = قصة حقيقية + الدرس + مشهد مضمونة واحد + CTA `/start` بـ`utm_source=email&utm_medium=newsletter&utm_content=<key>`.
