...
// 🔄 (٩/٩/٢٠٢٦) v97 — نشرنا ~١٤ مرة النهارده من غير رفع النسخة، فمفيش جهاز مفتوح
//    اتبلّغ يعمل reload (SW_UPDATED/versionGuard مربوطين بالرقم ده). محمد: «المشكلة لسه
//    قايمة» — لأن تليفونه لسه على الكود القديم. أي نشر بيغيّر سلوك الكلاينت = ارفع الرقم.
const CACHE_NAME = 'madmona-v121';
