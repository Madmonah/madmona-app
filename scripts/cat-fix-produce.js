// بديل خضار وفاكهة (الأولى فيها ووترمارك) — نزّل مرشحين 5 و6 و9 للمقارنة
...
;(async () => {
  for (const i of [5, 6, 9]) {
    const c = man['shop-produce'][i];
    if (!c) continue;
    const ok = await dl(c.regular, `E:/madmona-app/scripts/cat-final/produce-alt-${i}.jpg`);
    console.log('alt', i, ok ? 'OK' : 'FAIL', c.lic);
  }
})();
