// ⏱️ يظبط مدد مشاهد ريل واحد على طول الفويس أوفر (+٠.٦ ث) — بيشتغل على الكيان الحرفي في reels.config.js (len: X).
// الاستخدام: node _fit2.cjs <slug>   (الصوت: vo-<slug>-lahajati.mp3)
...
let s = fs.readFileSync(D + 'reels.config.js', 'utf8')
