      ...
      <main className="max-w-3xl mx-auto px-4 pb-12">
        ...
        <section className="py-10 md:py-16 text-center">
          ...
          <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
            مضمونة بدأت كمساحة عمل مشتركة في مصر الجديدة، وكبرت لتكون منصة لحجز كل أنواع المساحات والخدمات من موردين معتمدين في القاهرة.
          </p>
        </section>
        ...
        <section className="bg-white rounded-2xl border border-gray-100 p-6 md:p-8 mb-6">
          ...
          <div className="space-y-3 text-gray-700 leading-relaxed text-sm md:text-base">
            ...
            <p>
              <strong>Madmona Marketplace</strong> هو الجواب: منصة حجز شاملة تربط العملاء بموردين معتمدين بنراجع مستنداتهم وضمان كامل لكل حجز.
            </p>
          </div>
        </section>
        ...
        <section className="mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <FeatureCard
              ...
              description="عقارات، مركبات، معدات، وفعاليات من موردين معتمدين."
        ...
        <section className="bg-white rounded-2xl border border-gray-100 p-6 md:p-8 mb-6">
          ...
          <div className="space-y-4">
            ...
            <ValueRow
              ...
              description="بنراجع مستندات كل مورد قبل ما يعرض خدماته. كل مورد على Madmona موثّق."
            />
            <ValueRow
