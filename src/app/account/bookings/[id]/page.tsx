    ...
    return (
      <div className="min-h-screen bg-[#FAFAF7] flex items-center justify-center p-4" dir={dir}>
        <div className="bg-white rounded-2xl border p-8 text-center max-w-sm">
          ...
          <Link href="/account/bookings" className="inline-block bg-[#2B4521] text-white px-5 py-2.5 rounded-xl font-semibold mt-4">
      ...
      <main className="max-w-2xl mx-auto px-4 py-4 space-y-3">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-4 space-y-2">
          ...
          <div className="flex justify-between font-bold pt-2 border-t border-gray-100">
            ...
            <span className="text-[#2B4521]">{Number(booking.total_amount).toLocaleString(locale)} {t('common.egp')}</span>
          </div>
        </div>
        ...
        {booking.supplier_notes && (
          <div className="bg-white rounded-2xl border border-gray-100 p-4">
            <h2 className="text-sm font-bold text-gray-900 mb-2 flex items-center gap-2">
              <FileText className="w-4 h-4 text-[#2B4521]" /> {t('bdetail.supplier_notes')}
            </h2>
        ...
        {canReview && (
          <form onSubmit={handleSubmitReview} className="bg-white rounded-2xl border border-gray-100 p-4 space-y-3">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2B4521]/30"
            />
