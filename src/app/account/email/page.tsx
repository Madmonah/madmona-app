          ...
          <div className="space-y-4 animate-slide-up">
            ...
            {step === 'view' && (
              <>
                  ...
                  <div className="bg-white rounded-3xl shadow-soft p-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[11px] text-[#1F6F5F] font-bold flex items-center gap-1 mt-0.5">
                ...
                <button
                  ...
                  className="w-full bg-[#1F6F5F] text-white py-4 rounded-2xl font-bold text-base shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2"
                >
            ...
            {step === 'form' && (
              <form onSubmit={startChange} className="bg-white rounded-3xl shadow-soft p-6 space-y-5">
                ...
                <button
                  ...
                  className="w-full text-center text-xs font-bold text-gray-400 hover:text-[#1F6F5F] transition-colors"
                >
                  رجوع
                </button>
              </form>
            ...
            {step === 'done' && (
              <div className="bg-white rounded-3xl shadow-soft p-8 text-center">
                ...
                <Link
                  href="/account"
                  className="inline-block bg-[#1F6F5F] text-white px-8 py-3 rounded-2xl text-sm font-bold shadow-elevated hover:-translate-y-0.5 transition-all"
                >
                  رجوع لحسابي
                </Link>
              </div>
