...
export const metadata = {
  // 🧹 (٤/٩/٢٠٢٦) الويزارد الخماسي اتشال ٢٨/٨ — العنوان كان لسه بيقول ٥ خطوات
  title: 'ضيف إعلانك في دقيقة — مضمونة',
  description:
    'ضيف عقارك أو سيارتك أو معداتك على مضمونة في شاشة واحدة. مفيش حساب لازم في البداية — هنعملك واحد في الآخر تلقائيًا.',
};
  ...
  try {
    ...
    return tops.map((top) => {
      ...
      return {
        ...
        group_name_i18n: (top as { group_name_i18n?: Record<string, string> | null }).group_name_i18n ?? null,
