...
export default function ListingSuccessPage() {
  return (
    <Suspense fallback={
      <div dir="rtl" lang="ar" className="min-h-screen bg-[#2B4521] text-[#FAF7F0] flex items-center justify-center">
        جاري التحميل...
      </div>
    }>
...
function ListingSuccessPageInner() {
  ...
  return (
    <div dir="rtl" lang="ar" className="min-h-screen bg-[#2B4521] text-[#FAF7F0] flex items-center justify-center px-5">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="grid gap-3">
          <a
            ...
            className="block py-4 rounded-xl bg-[#FAF7F0] text-[#2B4521] font-black text-center border-2 border-[#2FA084]"
          >
            ➕ ضيف صنف تاني — بياناتك محفوظة
          </a>
          <a
            href={`/signup?token=${token}&phone=${encodeURIComponent(draft?.contact_phone || '')}`}
            className="block py-4 rounded-xl bg-[#2FA084] text-[#2B4521] font-bold text-center"
          >
            أنشئ حسابي دلوقتي →
          </a>
