...
export default function ListingSuccessPage() {
  ...
  return (
    <div dir="rtl" lang="ar" className="min-h-screen bg-[#1F5F3F] text-[#FAF7F0] flex items-center justify-center px-5">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="bg-[#FAF7F0]/5 border border-[#FAF7F0]/10 rounded-2xl p-5 mb-6 text-right">
          <div className="text-sm font-semibold mb-3 text-[#B8860B]">الخطوة الجاية: أنشئ حسابك (دقيقة واحدة)</div>
        ...
        <div className="grid gap-3">
          <a
            ...
            className="block py-4 rounded-xl bg-[#B8860B] text-[#1F5F3F] font-bold text-center"
          >
            أنشئ حسابي دلوقتي →
          </a>
        ...
        <div className="mt-8 text-xs text-[#FAF7F0]/40">
          محتاج مساعدة؟ كلمنا على الواتس اب: <a href="https://wa.me/201002229982" className="text-[#B8860B]">01002229982</a>
        </div>
      </div>
    </div>
  );
