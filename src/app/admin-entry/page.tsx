...
const C = {
  green: '#1F6F5F', greenMid: '#2FA084', gold: '#d4a017',
...
export default function AdminEntryPage() {
  ...
  return (
    <div dir="rtl" style={{ fontFamily: 'Cairo, Tahoma, sans-serif', background: C.cream, minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 380, background: C.white, border: `1px solid ${C.line}`, borderRadius: 22, padding: '32px 26px', boxShadow: '0 14px 44px rgba(31,111,95,0.13)' }}>
