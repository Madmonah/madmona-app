    ...
    <div dir="rtl" style={{
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          <div>
            <h1 style={{ color: '#059669', margin: 0, fontSize: 24 }}>⚡ النشاط المباشر</h1>
            <p style={{ color: '#666', margin: '4px 0 0', fontSize: 13 }}>كل اللي بيحصل في آخر 24 ساعة</p>
          </div>
          <a href="/admin/agents" style={{ color: '#059669', fontSize: 13, textDecoration: 'none' }}>← العودة للداشبورد</a>
        </div>
              ...
              <div key={idx} style={{
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 8 }}>
                    <strong style={{ color: '#059669', fontSize: 13 }}>{item.title}</strong>
