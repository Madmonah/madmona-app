    ...
    <div dir="rtl" style={{
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          <div>
            <h1 style={{ color: '#2B4521', margin: 0, fontSize: 26 }}>📣 Ad Builder</h1>
          ...
          <div style={{ display: 'flex', gap: 12, fontSize: 13 }}>
            ...
            <a href="/admin/activity" style={{ color: '#2B4521' }}>← Activity</a>
          </div>
        </div>

        <div style={{ background: '#fff', padding: 16, borderRadius: 12, marginBottom: 20, border: '1px solid #eee' }}>
          <h3 style={{ color: '#2B4521', margin: '0 0 8px', fontSize: 14 }}>📌 إزاي تستخدم الـ Ad Builder؟</h3>
          <ol style={{ margin: 0, paddingRight: 20, fontSize: 13, color: '#444', lineHeight: 1.8 }}>
            ...
            <li>راقب الـ leads في <a href="/admin/leads-feed" style={{ color: '#2B4521' }}>Leads Feed</a></li>
          </ol>
        </div>
