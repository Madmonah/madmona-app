    ...
    <div dir="rtl" style={{ fontFamily: 'Tahoma', background: '#FAF7F0', minHeight: '100vh', padding: 24 }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          <h1 style={{ color: '#2B4521', margin: 0, fontSize: 26 }}>🎨 Ad Creatives</h1>
            ...
            {all.map(ad => (
              <div key={ad.id} style={{ background: '#fff', padding: 20, borderRadius: 12, border: '1px solid #eee' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
                  <h2 style={{ margin: 0, color: '#2B4521', fontSize: 18 }}>
                ...
                {ad.visual_concept && (
                  <details style={{ marginTop: 12, fontSize: 12 }}>
                    <summary style={{ cursor: 'pointer', color: '#2B4521' }}>🎨 Visual Concept</summary>
