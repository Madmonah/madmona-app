...
const LOCKED_PALETTE = ['#059669', '#FAFAF7', '#1A2E26', '#6B7280', '#FFFFFF']
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-5">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              <p className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#059669] mb-1">PHASE Ω.14 · BRAND REVIEW</p>
            ...
            <div className="flex items-center gap-6 text-sm">
              ...
              <div>
                ...
                <p className="text-2xl font-black text-[#059669]">{stats.onBrand}</p>
              </div>
              <div>
                ...
                <article key={ad.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                  ...
                  <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100">
                    <div className="flex items-center gap-2">
                      <span className={`px-2.5 py-1 rounded-md text-[10px] font-bold tracking-wider uppercase ${
                        ad.status === 'approved' ? 'bg-[#34D399]/10 text-[#059669]' :
                    ...
                    <div className="flex items-center gap-1.5">
                      {onBrand ? (
                        <span className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-[#059669]">
                  ...
                  <div className="p-5">
                    ...
                    {(ad.cta_text || (ad.hashtags && ad.hashtags.length > 0)) && (
                      <div className="flex items-center gap-2 flex-wrap mb-3">
                        {ad.cta_text && (
                          <span className="px-2.5 py-1 rounded-md bg-[#34D399]/10 text-[#059669] text-[11px] font-bold">
                            ↳ {ad.cta_text}
                          </span>
                        )}
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-1.5 text-xs font-bold text-[#6B7280] hover:text-[#059669] py-2 border-t border-gray-100 mt-2 transition-colors"
                    >
                  ...
                  <div className="grid grid-cols-3 border-t border-gray-100">
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 py-3 text-xs font-bold text-[#059669] hover:bg-[#34D399]/5 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                    >
