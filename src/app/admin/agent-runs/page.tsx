    ...
    <div dir="rtl" style={pageStyle}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <header style={{ marginBottom: 20, textAlign: 'center' }}>
          <h1 style={{ color: '#059669', margin: 0, fontSize: 26 }}>🔁 Agent Runs</h1>
            ...
            <tbody>
              ...
              {runs.map(r => (
                <tr key={r.id} style={{ borderTop: '1px solid #E5E5E0' }}>
                  <td style={tdStyle}>
                    <a href={`/admin/agent-runs?agent=${r.agent_name}`} style={{ color: '#059669', textDecoration: 'none' }}>
                      {r.agent_name}
                    </a>
                  </td>
...
const thStyle: React.CSSProperties = {
  padding: 10, textAlign: 'right', fontWeight: 600, color: '#059669',
