...
const TEAMS = {
  sales: { label: '💰 Sales', color: '#FA8125' },
  ...
  operations: { label: '💼 Operations', color: '#FA8125' },
    ...
    <div dir="rtl" style={{
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <header style={{ marginBottom: 24 }}>
          <h1 style={{ color: '#FA8125', margin: 0, fontSize: 30, fontWeight: 'bold', textAlign: 'center' }}>
        ...
        <section style={{
          background: 'linear-gradient(135deg, #FA8125 0%, #2FA084 100%)',
        ...
        <section style={{ marginBottom: 24 }}>
          ...
          {(collabsCount.count ?? 0) > 0 && (
            <a href="/admin/collaborations" style={bannerStyle('linear-gradient(135deg, #FA8125 0%, #10B981 100%)')}>
        ...
        <h2 style={{ color: '#FA8125', marginTop: 32, marginBottom: 12, fontSize: 18 }}>
          الفرق والأجينتس
        </h2>
        <AIOSControls
...
function CategorySection({
  ...
  return (
    <section style={{ marginBottom: 16 }}>
      <h3 style={{
        color: '#FA8125', fontSize: 13, fontWeight: 600,
      ...
      <div style={{
        ...
        {cards.map((c, i) => (
          ...
          >
            <div style={{ fontSize: 24, fontWeight: 'bold', color: '#FA8125' }}>
              {c.val}
            </div>
...
const navLinkStyle: React.CSSProperties = {
  color: '#FA8125', textDecoration: 'none', fontSize: 12,
