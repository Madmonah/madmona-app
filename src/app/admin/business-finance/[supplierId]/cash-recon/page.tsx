      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              <p className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#2B4521] mb-1">B2B PARTNER · CASH RECON</p>
          ...
          <div className="divide-y divide-gray-100">
            {loading ? (
              ...
              <div className="py-12 text-center">
                ...
                <button onClick={() => setShowAdd(true)} className="mt-3 px-4 py-2 rounded-xl bg-[#2B4521] text-white text-sm font-bold">جرد كاش الفرع</button>
              </div>
              ...
              return (
                <div key={r.id} className="grid grid-cols-12 gap-3 px-4 py-3 items-center text-sm">
                  ...
                  <div className={`col-span-2 text-center font-mono font-black ${variance < 0 ? 'text-red-600' : variance > 0 ? 'text-[#2B4521]' : 'text-[#6B7280]'}`}>
                    {variance > 0 ? '+' : ''}{variance.toLocaleString()}
                  </div>
                  <div className="col-span-2">
                    {variance === 0 ? (
                      <span className="px-2 py-0.5 rounded bg-[#2B4521]/10 text-[#2B4521] text-[10px] font-bold">مطابق ✓</span>
      ...
      <div className="relative bg-white rounded-t-3xl md:rounded-3xl w-full md:max-w-md md:mx-4 max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="p-5 space-y-3">
          ...
          <div className="rounded-xl bg-[#FAFAF7] p-3 space-y-1.5">
            ...
            <div className={`flex justify-between text-sm font-black font-mono ${variance < 0 ? 'text-red-600' : variance > 0 ? 'text-[#2B4521]' : 'text-[#1A2E26]'}`}>
