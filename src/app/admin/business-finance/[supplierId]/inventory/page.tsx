...
const CATEGORY_COLORS: Record<string, string> = {
  hair_color: 'bg-[#34D399]/10 text-[#059669]',
  ...
  spare_parts: 'bg-[#34D399]/10 text-[#059669]',
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              <p className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#059669] mb-1">B2B PARTNER · INVENTORY</p>
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={() => setAddOpen(true)} className="px-4 py-2 rounded-xl bg-[#34D399] hover:bg-[#1A5D4F] text-sm font-bold text-[#04352A] flex items-center gap-2">
                <Plus className="w-4 h-4" /> منتج جديد
              </button>
              <button onClick={() => setImportOpen(true)} className="px-4 py-2 rounded-xl bg-white border border-[#059669]/30 hover:bg-[#34D399]/5 text-sm font-bold text-[#059669] flex items-center gap-2">
          ...
          <div className="flex gap-2 flex-wrap items-center">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold ${
                categoryFilter === null ? 'bg-[#34D399] text-[#04352A]' : 'bg-[#FAFAF7] text-[#1A2E26] hover:bg-gray-100'
              }`}
            >
            ...
            {sortedCategories.map(([cat, count]) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-bold ${
                  categoryFilter === cat ? 'bg-[#34D399] text-[#04352A]' : 'bg-[#FAFAF7] text-[#1A2E26] hover:bg-gray-100'
                }`}
              >
      ...
      <div className="bg-white w-full md:max-w-lg rounded-t-3xl md:rounded-3xl max-h-[92vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-100 p-4 flex items-center justify-between">
          <h2 className="text-lg font-black text-[#1A2E26] flex items-center gap-2">
            <Plus className="w-5 h-5 text-[#059669]" /> منتج جديد
          </h2>
        ...
        <div className="sticky bottom-0 bg-white border-t border-gray-100 p-4 flex gap-2">
          ...
          <button
            ...
            className="flex-1 bg-[#34D399] text-[#04352A] py-3 rounded-xl font-bold text-sm hover:bg-[#1A5D4F] disabled:opacity-60 flex items-center justify-center gap-2"
          >
    ...
    <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[85vh] overflow-y-auto p-6" dir="rtl" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-black text-[#1A2E26] flex items-center gap-2">
            <FileSpreadsheet className="w-5 h-5 text-[#059669]" /> استيراد مخزون من Excel
          </h2>
        ...
        <input
          ...
          className="w-full text-sm mb-4 file:ml-3 file:px-4 file:py-2 file:rounded-xl file:border-0 file:bg-[#34D399] file:text-[#04352A] file:font-bold file:cursor-pointer"
        ...
        {rows.length > 0 && (
          <>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-[#34D399] hover:bg-[#1A5D4F] text-[#04352A] font-bold flex items-center justify-center gap-2 disabled:opacity-60"
            >
        ...
        {result && <p className="mt-3 text-sm font-bold text-[#059669]">{result}</p>}
    ...
    <div className="grid grid-cols-12 gap-3 px-4 py-3 hover:bg-[#FAFAF7] transition-colors items-center text-sm">
      ...
      <div className="col-span-2 text-center">
        {p.stock_value && p.stock_value > 0 ? (
          <p className="text-sm font-black text-[#059669]">{Number(p.stock_value).toLocaleString()} ج</p>
        ) : (
