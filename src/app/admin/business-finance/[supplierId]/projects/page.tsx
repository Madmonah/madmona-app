      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              <p className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#059669] mb-1">مقاولات · المشاريع</p>
              <h1 className="text-2xl md:text-3xl font-black text-[#1A2E26] flex items-center gap-2">
                <FolderKanban className="w-7 h-7 text-[#059669]" /> المشاريع
              </h1>
            ...
            <div className="flex gap-2 flex-wrap">
              <button onClick={openAdd} className="px-4 py-2 rounded-xl bg-[#34D399] text-[#04352A] text-sm font-bold flex items-center gap-2 hover:shadow-md transition-shadow">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        {projects.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
            ...
            <button onClick={openAdd} className="mt-4 px-4 py-2 rounded-xl bg-[#34D399] text-[#04352A] text-sm font-bold inline-flex items-center gap-2">
              <Plus className="w-4 h-4" /> مشروع جديد
            </button>
          </div>
        ) : (
                ...
                <div key={p.id} className="bg-white rounded-2xl border border-gray-100 p-5 hover:shadow-sm transition-shadow flex flex-col">
                  ...
                  <div className="rounded-xl bg-[#FAFAF7] p-3 mb-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-lg font-black text-[#059669] font-mono">{EGP(p.contract_value)} <span className="text-xs font-medium text-[#6B7280]">ج</span></span>
                    </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="h-2 rounded-full bg-gray-100 overflow-hidden">
                      <div className="h-full bg-[#34D399] rounded-full transition-all" style={{ width: `${prog}%` }} />
                    </div>
                  </div>
                  ...
                  <div className="mt-auto flex items-center gap-2">
                    <Link
                      ...
                      className="flex-1 px-3 py-2 rounded-xl bg-[#34D399] text-[#04352A] text-xs font-bold flex items-center justify-center gap-1.5 hover:shadow-md transition-shadow"
                    >
          ...
          <div className="bg-white w-full md:max-w-lg rounded-t-3xl md:rounded-3xl max-h-[92vh] overflow-y-auto" dir="rtl" onClick={(e) => e.stopPropagation()}>
            <div className="sticky top-0 bg-white border-b border-gray-100 px-5 py-4 flex items-center justify-between">
              <h2 className="text-lg font-black text-[#1A2E26] flex items-center gap-2">
                <Layers className="w-5 h-5 text-[#059669]" /> {form.id ? 'تعديل مشروع' : 'مشروع جديد'}
              </h2>
