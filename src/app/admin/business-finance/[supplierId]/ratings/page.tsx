              ...
              {[
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded-lg text-xs font-bold transition-all ${
                    ratingFilter === f.v ? 'bg-[#34D399] text-[#04352A]' : 'text-[#6B7280]'
                  }`}
                >
                  {f.l}
                </button>
      ...
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-center gap-3 min-w-0">
          <div className={`inline-grid place-items-center w-10 h-10 rounded-xl flex-shrink-0 ${
            isLow ? 'bg-red-50 text-red-600' : 'bg-[#34D399]/10 text-[#059669]'
          }`}>
        ...
        <div className="text-left flex-shrink-0">
          ...
          {branchName && <p className="text-[10px] font-bold text-[#059669]">{branchName}</p>}
        </div>
      </div>
