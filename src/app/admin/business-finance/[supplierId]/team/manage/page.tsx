        ...
        <div className="max-w-5xl mx-auto px-4 py-4">
          ...
          <div className="mt-4 relative">
            ...
            <input
              ...
              className="w-full bg-[#FAFAF7] rounded-xl pr-10 pl-4 py-2.5 text-sm text-[#1A2E26] focus:outline-none focus:ring-2 focus:ring-[#1F6F5F]/30 border border-gray-200 placeholder-[#6B7280]"
            />
          </div>
        </div>
      </header>
        ...
        {[...grouped.entries()]
          ...
          <section key={branchKey} className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
            <div className="px-5 py-3 border-b border-gray-100 flex items-center gap-3 bg-[#FAFAF7]/50">
              <div className="inline-grid place-items-center w-9 h-9 rounded-xl bg-[#1F6F5F]/10 text-[#1F6F5F]">
                ...
                return (
                  <div key={e.employee_id} className="px-4 py-3 flex flex-col md:flex-row md:items-center gap-3">
                    <div className="flex items-center gap-3 md:w-56 flex-shrink-0">
                      <div className="inline-grid place-items-center w-10 h-10 rounded-xl bg-[#1F6F5F]/10 text-[#1F6F5F] font-black flex-shrink-0">
                    ...
                    <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-2">
                      <label className="relative">
                        ...
                        <input
                          ...
                          inputMode="tel"
                          className="w-full bg-[#FAFAF7] rounded-lg pr-8 pl-2 py-2 text-sm text-[#1A2E26] focus:outline-none focus:ring-2 focus:ring-[#1F6F5F]/30 border border-gray-200 placeholder-[#6B7280]"
                        />
                      </label>
                      <label className="relative">
                      ...
                      <select
                        ...
                        className="w-full bg-[#FAFAF7] rounded-lg px-2 py-2 text-sm text-[#1A2E26] focus:outline-none focus:ring-2 focus:ring-[#1F6F5F]/30 border border-gray-200"
                      >
                    ...
                    <div className="flex items-center gap-2 md:w-32 justify-end flex-shrink-0">
                      {st?.msg && (
                        <span className={`text-[11px] font-bold ${st.err ? 'text-red-600' : 'text-[#1F6F5F]'}`}>
                          {st.msg}
                        </span>
                      )}
                      <button
