      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-6">
          ...
          <p className="text-sm text-gray-600 mt-1">
            كل الـ applications اللي وصلت من <a href="/careers" target="_blank" className="text-[#1F6F5F] underline">madmonacairo.com/careers</a>
          </p>
        </header>
          ...
          {[
            ...
            <button
              ...
              className={`${s.color} rounded-xl p-3 border-2 text-right hover:shadow-md transition ${
                filterStatus === s.key ? 'border-[#1F6F5F]' : 'border-transparent'
              }`}
            >
        ...
        <div className="mb-4">
          <input
            ...
            className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:border-[#1F6F5F]"
          />
        </div>
                    ...
                    return (
                      <tr key={a.id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 font-mono text-xs">
                          {a.phone ? (
                            <a href={`https://wa.me/${a.phone.replace(/\D/g, '')}`} target="_blank" className="text-[#1F6F5F] hover:underline">
                              {a.phone}
                            </a>
                          ) : '—'}
                        </td>
                        ...
                        <td className="px-4 py-3">
                          {a.cv_url ? (
                            <a href={a.cv_url} target="_blank" className="text-[#1F6F5F] underline text-xs">
                              📄 CV
                            </a>
                          ) : '—'}
                        </td>
