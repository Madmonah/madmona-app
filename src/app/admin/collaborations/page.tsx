    ...
    <div dir="rtl" style={{ fontFamily: 'Tahoma', background: '#FAF7F0', minHeight: '100vh', padding: 24 }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          <h1 style={{ color: '#059669', margin: 0, fontSize: 26 }}>🎯 Agent Collaborations</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 24 }}>
          {[
            { label: 'Collaborations', val: collaborations.length, color: '#059669' },
        ...
        <h2 style={{ color: '#059669', fontSize: 18, marginBottom: 12 }}>🤝 Active Collaborations</h2>
        ...
        <h2 style={{ color: '#059669', fontSize: 18, marginBottom: 12 }}>📬 Recent Messages</h2>
