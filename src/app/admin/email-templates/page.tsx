  ...
  if (stage === 'unauthenticated') return (
    <div className="min-h-screen bg-[#FAFAF7] flex items-center justify-center p-4" dir="rtl">
      <div className="bg-white rounded-2xl border p-8 text-center max-w-sm">
        ...
        <Link href="/auth/login?redirect=/admin/email-templates" className="block bg-[#2B4521] text-white py-3 rounded-xl font-semibold">دخول</Link>
      </div>
    </div>
  )
    ...
    <div className="min-h-screen bg-[#FAFAF7] pb-20" dir="rtl">
      <header className="sticky top-0 z-40 bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <FileText className="w-5 h-5 text-[#2B4521]" />
            ...
            <div key={t.template_key} className="bg-white rounded-2xl border border-gray-100 p-4">
              <div className="flex items-start gap-3 mb-2">
                ...
                <div className="flex-shrink-0 flex flex-col gap-1.5">
                  ...
                  <button onClick={() => sendTest(t)} disabled={sending} className="p-1.5 rounded-lg bg-[#2B4521] text-white disabled:opacity-50">
        ...
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/50 p-0 md:p-4" dir="rtl">
          <div className="bg-white rounded-t-3xl md:rounded-3xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="sticky bottom-0 bg-white border-t border-gray-100 px-5 py-4 flex gap-2">
              ...
              <button onClick={save} disabled={saving} className="flex-1 py-3 rounded-xl bg-[#2B4521] hover:bg-[#2B4521]/90 text-white font-bold text-sm flex items-center justify-center gap-2 disabled:opacity-50">
