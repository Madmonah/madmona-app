    ...
    <div dir="rtl" style={{
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          <div>
            <h1 style={{ color: '#059669', margin: 0, fontSize: 26 }}>🎯 Leads Feed</h1>
            <p style={{ color: '#666', margin: '4px 0 0', fontSize: 13 }}>كل الـ leads جاية من الـ landing page</p>
          </div>
          <div style={{ display: 'flex', gap: 12 }}>
            <a href="/admin/agents" style={{ color: '#059669', fontSize: 13 }}>← الفريق</a>
            <a href="/admin/activity" style={{ color: '#059669', fontSize: 13 }}>← النشاط</a>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 24 }}>
          {[
            { label: 'إجمالي الـ Leads', val: total, color: '#059669' },
              ...
              <div key={lead.id} style={{
                ...
                <div style={{ minWidth: 0 }}>
                  <div style={{ display: 'flex', gap: 12, alignItems: 'baseline', marginBottom: 4 }}>
                    <strong style={{ color: '#059669', fontSize: 16 }}>{lead.contact_name ?? 'مجهول'}</strong>
                    <span style={{
                      fontSize: 11,
                      padding: '2px 8px',
                      borderRadius: 12,
