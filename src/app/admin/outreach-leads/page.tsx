      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
            <div className="text-3xl font-bold text-[#1F6F5F]">{totalLeads}</div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 bg-gray-100 rounded-full h-2 relative overflow-hidden">
                    <div
                      className="absolute right-0 top-0 h-full bg-gradient-to-l from-[#2FA084] to-[#1F6F5F]"
                      style={{ width: `${pct}%` }}
                    />
                  </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 mb-4 flex flex-wrap gap-3 items-center">
          ...
          <button
            onClick={refresh}
            className="px-4 py-2 bg-[#1F6F5F] text-white rounded-lg hover:bg-[#2d7a52]"
          >
            تحديث
          </button>
        </div>
