      ...
      <div className="ov" dir="rtl">
        ...
        <div style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', padding: 16 }}>
          <div className="card" style={{ padding: 30, textAlign: 'center', maxWidth: 340 }}>
            ...
            <Link href="/auth/login?redirect=/admin/overview" className="cta" style={{ display: 'inline-flex' }}>تسجيل دخول</Link>
          </div>
        </div>
      </div>
    )
        ...
        <aside className="side">
          ...
          <nav>
            <div className="nav-group">
              ...
              <Link className="nav-item active" href="/admin/overview">
        ...
        <div className="main">
          <header className="topbar">
            ...
            <div className="tb-right">
              ...
              <Link className="icon-btn" href="/admin/dashboard" title="كل الأدوات">
