...
const PIPELINE_META: Record<string, { icon: typeof Megaphone; gradient: string; emoji: string; arabicName: string }> = {
  'daily-content': { icon: Megaphone, gradient: 'from-[#FA8125] to-[#F98F2A]', emoji: '🎬', arabicName: 'محتوى اليوم' },
...
export default function PipelinesPage() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#FAF7F0] to-[#f5efe1] flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-12 h-12 text-[#FA8125] animate-spin mx-auto mb-4" />
          <p className="text-[#FA8125] font-bold">جاري تحميل النظام...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#FAF7F0] to-[#f5efe1] flex items-center justify-center p-6">
        <div className="bg-white rounded-3xl p-8 shadow-2xl max-w-md text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-[#FA8125] text-white rounded-xl font-bold hover:bg-[#164a30] transition-colors"
          >
            حاول تاني
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FAF7F0] via-[#f5efe1] to-[#FAF7F0]" dir="rtl">
      {/* ============== HERO ============== */}
      <header className="relative overflow-hidden bg-gradient-to-br from-[#0F3324] via-[#FA8125] to-[#F98F2A] text-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 text-xs text-gray-500 hover:text-[#FA8125] transition-colors"
          >
