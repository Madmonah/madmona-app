...
const PIPELINE_META: Record<string, { icon: typeof Megaphone; gradient: string; emoji: string; arabicName: string }> = {
  'daily-content': { icon: Megaphone, gradient: 'from-[#34D399] to-[#34D399]', emoji: '🎬', arabicName: 'محتوى اليوم' },
  'lead-funnel': { icon: Target, gradient: 'from-[#2FA084] to-[#d4a017]', emoji: '🎯', arabicName: 'تأهيل وقفل العملاء' },
  'quality-trust': { icon: Shield, gradient: 'from-[#6FCF97] to-[#34D399]', emoji: '🛡️', arabicName: 'الجودة والأمان' },
...
export default function PipelinesPage() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#FAF7F0] to-[#f5efe1] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#059669] font-bold">جاري تحميل النظام...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#FAF7F0] to-[#f5efe1] flex items-center justify-center p-6">
        <div className="bg-white rounded-3xl p-8 shadow-2xl max-w-md text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-[#34D399] text-[#04352A] rounded-xl font-bold hover:bg-[#164a30] transition-colors"
          >
            حاول تاني
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FAF7F0] via-[#f5efe1] to-[#FAF7F0]" dir="rtl">
      {/* ============== HERO ============== */}
      <header className="relative overflow-hidden bg-gradient-to-br from-[#0F3324] via-[#34D399] to-[#34D399] text-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 text-xs text-gray-500 hover:text-[#059669] transition-colors"
          >
