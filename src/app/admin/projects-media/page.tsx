                        ...
                        return (
                          <div key={m.url} className="shrink-0 w-32">
                            <div className="relative">
                              {m.kind === 'image' ? (
                                ...
                                <img
                                  ...
                                  className={`w-32 h-24 object-cover rounded-lg border-2 ${
                                    isCover ? 'border-[#FA8125]' : 'border-gray-100'
                                  }`}
                                />
                              ) : (
                                <a
                                  ...
                                  className={`w-32 h-24 rounded-lg border-2 flex flex-col items-center justify-center gap-1 bg-gray-50 ${
                                    isPdf ? 'border-[#FA8125]' : 'border-gray-100'
                                  }`}
                                >
                              ...
                              {(isCover || isPdf) && (
                                <span className="absolute top-1 right-1 bg-[#FA8125] text-white text-[9px] px-1.5 py-0.5 rounded-full font-semibold">
                            ...
                            <div className="flex gap-1 mt-1">
                              {m.kind === 'image' && !isCover && (
                                <button
                                  ...
                                  disabled={b}
                                  className="flex-1 text-[10px] font-semibold py-1 rounded bg-gray-100 hover:bg-[#FA8125] hover:text-white disabled:opacity-50 transition-colors"
                                >
                                  {b ? '...' : 'اعملها Cover'}
                                </button>
                              )}
