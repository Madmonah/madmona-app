    ...
    <div dir="rtl" className="min-h-screen bg-[#FAFAF7] p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        <header className="flex flex-wrap items-center justify-between gap-3 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-[#059669]">🏗️ مشاريع البورصة</h1>
            ...
            >
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#34D399]/10 text-[#059669] font-semibold">
                    {p.area_label}
                  </span>
                  {p.status !== 'published' && (
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                {p.brochure_url && (
                  <a href={p.brochure_url} target="_blank" rel="noopener"
                    className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center text-gray-600 hover:border-[#059669]/40" title="البروشور">
                    <FileText className="w-4 h-4" />
                  </a>
                )}
                {p.video_url && (
                  <a href={p.video_url} target="_blank" rel="noopener"
                    className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center text-gray-600 hover:border-[#059669]/40" title="الفيديو">
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center text-gray-600 hover:border-[#059669]/40 disabled:opacity-30 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center text-gray-600 hover:border-[#059669]/40"
                  title="عدّل"
                >
