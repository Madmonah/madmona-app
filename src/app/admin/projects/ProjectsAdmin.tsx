    ...
    <div dir="rtl" className="min-h-screen bg-[#FAFAF7] p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
        <header className="flex flex-wrap items-center justify-between gap-3 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-[#FA8125]">🏗️ مشاريع البورصة</h1>
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full border border-gray-200 bg-white text-sm font-semibold text-gray-700 hover:border-[#FA8125]/40"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#FA8125] text-white text-sm font-bold"
            >
            ...
            >
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#FA8125]/10 text-[#FA8125] font-semibold">
                    {p.area_label}
                  </span>
                  {p.status !== 'published' && (
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                {p.brochure_url && (
                  <a href={p.brochure_url} target="_blank" rel="noopener"
                    className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center text-gray-600 hover:border-[#FA8125]/40" title="البروشور">
                    <FileText className="w-4 h-4" />
                  </a>
                )}
                {p.video_url && (
                  <a href={p.video_url} target="_blank" rel="noopener"
                    className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center text-gray-600 hover:border-[#FA8125]/40" title="الفيديو">
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center text-gray-600 hover:border-[#FA8125]/40 disabled:opacity-30 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center text-gray-600 hover:border-[#FA8125]/40"
                  title="عدّل"
                >
