    ...
    <div dir="rtl" style={{ fontFamily: 'Tahoma', background: '#FAF7F0', minHeight: '100vh', padding: 24 }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          <h1 style={{ color: '#1F5F3F', margin: 0, fontSize: 26 }}>🧠 Prompt Versions</h1>
          <a href="/admin/performance" style={{ color: '#1F5F3F', fontSize: 13 }}>← Performance</a>
        </div>
          ...
          <div style={{ display: 'grid', gap: 16 }}>
            {Array.from(byAgent.entries()).map(([agent, vs]) => (
              <div key={agent} style={{
                ...
                <h2 style={{ margin: 0, color: '#1F5F3F', fontSize: 18, marginBottom: 12 }}>
