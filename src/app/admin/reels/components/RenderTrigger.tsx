    ...
    <div style={{ marginBottom: 24 }}>
      <button
        ...
        style={{
          background: loading || draftedReels.length === 0
            ? '#999'
            : 'linear-gradient(135deg, #2B4521 0%, #5A6E3A 50%, #2FA084 100%)',
          color: '#FAF7F0',
          border: 'none',
          padding: '14px 28px',
          borderRadius: 12,
          ...
          boxShadow: '0 6px 16px rgba(43, 69, 33, 0.3)',
          transition: 'all 0.2s',
        }}
      >
        {loading
        ...
        <div style={{ marginTop: 12, padding: 12, background: '#fff', borderRadius: 8, border: '1px solid #eee' }}>
          ...
          <div style={{ background: '#f0f0f0', height: 6, borderRadius: 3, overflow: 'hidden' }}>
            <div style={{
              ...
              background: 'linear-gradient(90deg, #2B4521, #2FA084)',
      ...
      {results.length > 0 && (
        <div style={{
          ...
          <div style={{ fontWeight: 'bold', color: '#2B4521', marginBottom: 8 }}>
          ...
          {!loading && (
            <button
              ...
              style={{
                marginTop: 12, background: '#2B4521', color: '#fff', border: 'none',
