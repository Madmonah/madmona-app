    ...
    <div dir="rtl" style={{ fontFamily: 'Tahoma', background: '#FAF7F0', minHeight: '100vh', padding: 24 }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          <h1 style={{ color: '#FA8125', margin: 0, fontSize: 26 }}>🎬 Reel Scripts</h1>
            ...
            {all.map(reel => (
              <div key={reel.id} style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                  <h2 style={{ margin: 0, color: '#FA8125', fontSize: 18 }}>{reel.title}</h2>
                  <span style={{
                    background: reel.video_url ? '#FA8125' : reel.status === 'approved' ? '#d4edda' : '#fff3cd',
                ...
                {reel.video_url && (
                  <div style={{ margin: '12px 0', background: '#000', borderRadius: 8, overflow: 'hidden', maxWidth: 360 }}>
                    ...
                    />
                    <div style={{ padding: 8, background: '#FA8125', display: 'flex', gap: 8, alignItems: 'center' }}>
                ...
                {/* Hook */}
                <div style={{
                  background: '#FA8125', color: '#FAF7F0', padding: 16,
                ...
                {reel.hashtags && reel.hashtags.length > 0 && (
                  <p style={{ fontSize: 11, color: '#FA8125', margin: '8px 0', wordSpacing: '4px' }}>
                    {reel.hashtags.join(' ')}
                  </p>
                )}
