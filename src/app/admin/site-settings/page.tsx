...
const FIELD_GROUPS: FieldGroup[] = [
  ...
  },
  {
    ...
    iconColor: 'bg-[#2B4521]/10 text-[#2B4521]',
    fields: [
      {
    ...
    return (
      <div className="min-h-screen bg-[#FAFAF7] flex items-center justify-center p-4" dir="rtl">
        <div className="bg-white rounded-3xl shadow-luxe p-8 text-center max-w-sm">
          ...
          <Link href="/auth/login?redirect=/admin/site-settings" className="block bg-[#2B4521] text-white py-3 rounded-xl font-semibold">
            دخول
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7] pb-20" dir="rtl">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 px-1 pt-2">
            <div className="w-9 h-9 rounded-xl bg-[#2B4521]/10 text-[#2B4521] flex items-center justify-center">
...
function PaymentSettingField({
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="w-11 h-11 rounded-2xl bg-[#2B4521]/10 text-[#2B4521] flex items-center justify-center flex-shrink-0">
      ...
      <div className="flex-1 min-w-0">
        ...
        <input
          ...
          dir={field.dir || 'rtl'}
          className={`w-full px-3 py-2 bg-[#FAFAF7] border border-gray-100 rounded-xl text-xs focus:outline-none focus:bg-white focus:border-[#2B4521]/40 ${field.mono ? 'font-mono' : ''}`}
      ...
      <button
        ...
        className="px-3 py-2 bg-[#2B4521] hover:bg-[#2B4521]/90 text-white font-bold rounded-xl text-xs flex items-center justify-center gap-1.5 disabled:opacity-30 disabled:cursor-not-allowed transition-colors flex-shrink-0"
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-1">
          ...
          {hasValue && isValidUrl && (
            <a
              ...
              className="text-[10px] text-gray-400 hover:text-[#2B4521] flex items-center gap-1 no-underline"
            >
        ...
        <input
          ...
          className="w-full px-3 py-2 bg-[#FAFAF7] border border-gray-100 rounded-xl text-xs focus:outline-none focus:bg-white focus:border-[#2B4521]/40 font-mono"
          dir="ltr"
        ...
        <div className="md:col-span-2 space-y-3">
          ...
          <div>
            ...
            <button
              ...
              disabled={uploading}
              className="w-full px-4 py-2.5 bg-[#FAFAF7] hover:bg-gray-100 border-2 border-dashed border-gray-300 hover:border-[#2B4521]/40 rounded-xl text-sm font-bold text-gray-700 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {uploading ? (
                <>
          ...
          <div className="flex gap-2 pt-2">
            <button
              ...
              className="flex-1 px-4 py-2.5 bg-[#2B4521] hover:bg-[#2B4521]/90 text-white font-bold rounded-xl text-sm flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {saving ? (
                <>
                  <Loader2 className="w-4 h-4 animate-spin" />
