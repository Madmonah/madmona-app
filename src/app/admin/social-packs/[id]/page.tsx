  ...
  if (!pack) {
    return (
      <div className="min-h-screen bg-gray-50 p-8" dir="rtl">
        ...
        <Link href="/admin/social-packs" className="text-[#2B4521] underline">رجوع</Link>
      </div>
    )
  }
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-2 mt-3">
              <Link
                ...
                target="_blank"
                className="text-xs text-[#2B4521] hover:underline"
              >
                صفحة الـ listing ↗
              </Link>
            </div>
          ...
          <Section title="🏷 الـ Hashtags">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="text-xs text-[#2B4521] hover:underline whitespace-nowrap"
              >
                نسخ الكل
              </button>
            </div>
            ...
            {(pack.square_canva_url || pack.carousel_canva_url) && (
              <div className="flex gap-3 mt-3">
                {pack.square_canva_url && (
                  <a href={pack.square_canva_url} target="_blank" className="text-xs text-[#2B4521] hover:underline">
                    تصميم مربع ↗
                  </a>
                )}
                {pack.story_canva_url && (
                  <a href={pack.story_canva_url} target="_blank" className="text-xs text-[#2B4521] hover:underline">
                    ستوري ↗
                  </a>
                )}
                {pack.carousel_canva_url && (
                  <a href={pack.carousel_canva_url} target="_blank" className="text-xs text-[#2B4521] hover:underline">
                    كاروسيل ↗
                  </a>
                )}
              </div>
        ...
        >
          {groupPosts.length === 0 ? (
            <p className="text-sm text-gray-500">
              ...
              <Link href="/admin/social-groups" className="text-[#2B4521] underline">
                /admin/social-groups
              </Link>
            </p>
          ) : (
                ...
                >
                  <div className="flex items-start justify-between mb-2 gap-2">
                    <div className="flex-1 min-w-0">
                      ...
                      <a
                        ...
                        target="_blank"
                        className="text-xs text-gray-500 hover:text-[#2B4521] no-underline"
                      >
                        {g.group.group_url} ↗
                      </a>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="text-xs px-3 py-1.5 bg-[#2B4521] text-white rounded-lg font-bold hover:opacity-90"
                    >
                      نسخ النص
                    </button>
                    <a
                    ...
                    {g.external_post_url && (
                      <a
                        ...
                        target="_blank"
                        className="text-xs px-3 py-1.5 text-[#2B4521] underline"
                      >
                        البوست المنشور
                      </a>
                    )}
