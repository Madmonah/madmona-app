  ...
  if (!pack) {
    return (
      <div className="min-h-screen bg-gray-50 p-8" dir="rtl">
        ...
        <Link href="/admin/social-packs" className="text-[#059669] underline">رجوع</Link>
      </div>
    )
  }
          ...
          <Section title="🏷 الـ Hashtags">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="text-xs text-[#059669] hover:underline whitespace-nowrap"
              >
                نسخ الكل
              </button>
            </div>
            ...
            {(pack.square_canva_url || pack.carousel_canva_url) && (
              <div className="flex gap-3 mt-3">
                {pack.square_canva_url && (
                  <a href={pack.square_canva_url} target="_blank" className="text-xs text-[#059669] hover:underline">
                    تصميم مربع ↗
                  </a>
                )}
                {pack.story_canva_url && (
                  <a href={pack.story_canva_url} target="_blank" className="text-xs text-[#059669] hover:underline">
                    ستوري ↗
                  </a>
                )}
                {pack.carousel_canva_url && (
                  <a href={pack.carousel_canva_url} target="_blank" className="text-xs text-[#059669] hover:underline">
                    كاروسيل ↗
                  </a>
                )}
              </div>
        ...
        >
          {groupPosts.length === 0 ? (
            <p className="text-sm text-gray-500">
              ...
              <Link href="/admin/social-groups" className="text-[#059669] underline">
                /admin/social-groups
              </Link>
            </p>
          ) : (
                ...
                >
                  <div className="flex items-start justify-between mb-2 gap-2">
                    <div className="flex-1 min-w-0">
                      ...
                      <a
                        ...
                        target="_blank"
                        className="text-xs text-gray-500 hover:text-[#059669] no-underline"
                      >
                        {g.group.group_url} ↗
                      </a>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="text-xs px-3 py-1.5 bg-[#34D399] text-[#04352A] rounded-lg font-bold hover:opacity-90"
                    >
                      نسخ النص
                    </button>
                    <a
                    ...
                    {g.external_post_url && (
                      <a
                        ...
                        target="_blank"
                        className="text-xs px-3 py-1.5 text-[#059669] underline"
                      >
                        البوست المنشور
                      </a>
                    )}
