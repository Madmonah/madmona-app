        ...
        <section className="bg-white rounded-2xl border border-[#E5E5E0] overflow-hidden">
          <header className="px-5 py-4 border-b border-[#F5F4F0] flex items-center justify-between">
            ...
            <Link
              ...
              className="text-xs bg-[#FA8125] text-white px-3 py-1.5 rounded-lg font-bold hover:bg-[#FA8125]/90"
            >
              + بيع slot جديد
            </Link>
          </header>
              ...
              <div key={item.slug} className="px-5 py-4 flex items-center gap-4 hover:bg-[#FAFAF7]">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[9px] font-bold text-[#FA8125] bg-[#FA8125]/8 px-1.5 py-0.5 rounded uppercase tracking-widest">
                ...
                <div className="text-right flex-shrink-0">
                  <div className="text-lg font-black text-[#FA8125]">
