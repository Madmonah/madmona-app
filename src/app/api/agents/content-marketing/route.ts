...
function buildContentEmailHtml(post: ContentOutput, date: string, contentId?: string): string {
  ...
  <div style="border-right: 4px solid #FA8125; padding-right: 16px; margin-bottom: 24px;">
    <h2 style="color: #FA8125; margin: 0 0 4px 0;">📝 بوست النهارده</h2>
  ...
  <div style="background: #FAF7F0; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
    <h3 style="color: #FA8125; margin: 0 0 8px 0; font-size: 16px;">الموضوع</h3>
    <p style="margin: 0; font-size: 15px;">${escapeHtml(post.topic)}</p>
  </div>

  <div style="background: #FA8125; color: #FAF7F0; padding: 24px; border-radius: 8px; text-align: center; margin-bottom: 20px;">
  ...
  <h3 style="color: #FA8125; margin-top: 24px;">الكابشن (انسخه واستخدمه زي ما هو)</h3>
...
${escapeHtml(hashtagsLine)}</div>
  ...
  <h3 style="color: #FA8125; margin-top: 24px;">📐 الـ Design Brief (للـ Canva)</h3>
  ...
  <h3 style="color: #FA8125; margin-top: 24px;">⏰ أحسن وقت للنشر</h3>
