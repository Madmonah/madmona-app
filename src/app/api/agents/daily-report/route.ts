...
function buildReportEmailHtml(report: ReportOutput, m: DailyMetrics): string {
  ...
  <div style="background: #FA8125; color: #FAF7F0; padding: 24px; border-radius: 8px; margin-bottom: 24px;">
  ...
  <h3 style="color: #FA8125; margin-top: 24px;">📈 أرقام النهارده</h3>
  ...
  <h3 style="color: #FA8125; margin-top: 24px;">✅ Wins</h3>
  ...
  <h3 style="color: #FA8125; margin-top: 24px;">🎯 Actions لبكره</h3>
  <ul style="padding-right: 20px;">${actions}</ul>

  <h3 style="color: #FA8125; margin-top: 24px;">📌 Highlights</h3>
