...
<div style="background:linear-gradient(135deg,#1F6F5F 0%,#2d7a52 100%);color:#fff;padding:32px;border-radius:24px;text-align:center;margin-bottom:24px">
