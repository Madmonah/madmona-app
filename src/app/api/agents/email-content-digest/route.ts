...
<div style="background:linear-gradient(135deg,#2B4521 0%,#5A6E3A 100%);color:#fff;padding:32px;border-radius:24px;text-align:center;margin-bottom:24px">
