...
<div style="background:linear-gradient(135deg,#FA8125 0%,#F98F2A 100%);color:#fff;padding:32px;border-radius:24px;text-align:center;margin-bottom:24px">
