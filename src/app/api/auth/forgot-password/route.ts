        ...
        <tr><td style="padding:32px;">
          ...
          <div style="margin:32px 0; text-align:center;">
            <a href="${escapeHtml(args.resetUrl)}"
               style="display:inline-block; background:#2B4521; color:#fff; padding:14px 32px; border-radius:14px; text-decoration:none; font-weight:bold; font-size:15px;">
          ...
          <p style="margin: 16px 0 0; font-size:12px; color:#999; word-break: break-all; line-height:1.5;">
            ...
            <a href="${escapeHtml(args.resetUrl)}" style="color:#2B4521; text-decoration:none;">${escapeHtml(args.resetUrl)}</a>
          </p>
        </td></tr>
