...
export async function POST(req: Request) {
  ...
  return NextResponse.json({
    ok: false,
    // رسالة واحدة للكل — «مفيش حساب موظف» كانت بتلخبط العميل العادي
    error: 'الإيميل/الرقم أو الباسورد غلط — لو معندكش باسورد ادخل بجوجل أو بالواتساب، أو اعمل «نسيت الباسورد»',
  }, { status: 401 })
}
