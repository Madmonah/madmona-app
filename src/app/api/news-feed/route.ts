...
const CATEGORY_ICONS: Record<NewsCategory, string> = {
  ...
  automotive:
    '<path d="M -55 10 L -45 -20 L 45 -20 L 55 10 L 55 25 L -55 25 Z" stroke="#2FA084" stroke-width="6" fill="none" stroke-linejoin="round"/><circle cx="-30" cy="28" r="10" stroke="#2FA084" stroke-width="5" fill="#059669"/><circle cx="30" cy="28" r="10" stroke="#2FA084" stroke-width="5" fill="#059669"/>',
  business:
