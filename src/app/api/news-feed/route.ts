...
const CATEGORY_ICONS: Record<NewsCategory, string> = {
  economy:
    '<path d="M -50 30 L -15 -10 L 15 12 L 50 -35" stroke="#B8860B" stroke-width="6" fill="none" stroke-linecap="round" stroke-linejoin="round"/><circle cx="50" cy="-35" r="6" fill="#B8860B"/><path d="M -50 45 L 50 45" stroke="#B8860B" stroke-width="3" fill="none" opacity="0.5"/>',
  real_estate:
    '<rect x="-45" y="-15" width="90" height="55" stroke="#B8860B" stroke-width="6" fill="none" stroke-linejoin="round"/><polygon points="-55,-15 0,-50 55,-15" stroke="#B8860B" stroke-width="6" fill="none" stroke-linejoin="round"/><rect x="-15" y="10" width="30" height="30" stroke="#B8860B" stroke-width="4" fill="none"/>',
  automotive:
    '<path d="M -55 10 L -45 -20 L 45 -20 L 55 10 L 55 25 L -55 25 Z" stroke="#B8860B" stroke-width="6" fill="none" stroke-linejoin="round"/><circle cx="-30" cy="28" r="10" stroke="#B8860B" stroke-width="5" fill="#1F5F3F"/><circle cx="30" cy="28" r="10" stroke="#B8860B" stroke-width="5" fill="#1F5F3F"/>',
  business:
    '<rect x="-40" y="-15" width="80" height="55" rx="6" stroke="#B8860B" stroke-width="6" fill="none"/><path d="M -20 -15 L -20 -30 L 20 -30 L 20 -15" stroke="#B8860B" stroke-width="6" fill="none" stroke-linejoin="round"/><path d="M -40 12 L 40 12" stroke="#B8860B" stroke-width="3" opacity="0.5"/>',
  tourism:
    '<path d="M 0 -45 Q -20 -30 -25 -10 Q -28 5 -15 15 L 15 15 Q 28 5 25 -10 Q 20 -30 0 -45 Z" stroke="#B8860B" stroke-width="6" fill="none" stroke-linejoin="round"/><path d="M -45 30 Q -22 22 0 30 Q 22 38 45 30" stroke="#B8860B" stroke-width="5" fill="none" stroke-linecap="round"/><circle cx="0" cy="-15" r="4" fill="#B8860B"/>',
  fashion:
    '<path d="M -35 -25 L -50 35 L 50 35 L 35 -25 Z" stroke="#B8860B" stroke-width="6" fill="none" stroke-linejoin="round"/><circle cx="0" cy="-35" r="10" stroke="#B8860B" stroke-width="5" fill="none"/><path d="M -35 -25 L 35 -25" stroke="#B8860B" stroke-width="5" stroke-linecap="round"/>',
  tech:
    '<rect x="-35" y="-30" width="70" height="60" rx="6" stroke="#B8860B" stroke-width="6" fill="none"/><circle cx="0" cy="0" r="14" stroke="#B8860B" stroke-width="5" fill="none"/><path d="M -45 -15 L -35 -15 M -45 0 L -35 0 M -45 15 L -35 15 M 35 -15 L 45 -15 M 35 0 L 45 0 M 35 15 L 45 15" stroke="#B8860B" stroke-width="5" stroke-linecap="round"/>',
}

function makeFallbackSVG(category: NewsCategory): string {
  const label = CATEGORY_LABELS_AR[category]
  const icon = CATEGORY_ICONS[category]
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 600" preserveAspectRatio="xMidYMid slice"><defs><pattern id="dots" x="0" y="0" width="32" height="32" patternUnits="userSpaceOnUse"><circle cx="16" cy="16" r="0.8" fill="#FAF7F0" opacity="0.06"/></pattern></defs><rect width="1080" height="600" fill="#1F5F3F"/><rect width="1080" height="600" fill="url(#dots)"/><rect x="0" y="0" width="1080" height="6" fill="#B8860B"/><rect x="0" y="594" width="1080" height="6" fill="#B8860B"/><g transform="translate(540,250)">${icon}</g><text x="540" y="400" text-anchor="middle" font-family="Tahoma, Arial, sans-serif" font-size="68" font-weight="700" fill="#FAF7F0">${label}</text><text x="540" y="450" text-anchor="middle" font-family="Tahoma, Arial, sans-serif" font-size="22" font-weight="400" fill="#FAF7F0" opacity="0.65">آخر الأخبار · من Madmona</text><text x="540" y="555" text-anchor="middle" font-family="Arial, sans-serif" font-size="18" font-weight="600" fill="#B8860B" letter-spacing="6">MADMONA · احنا بتوع الإيجار</text></svg>`
