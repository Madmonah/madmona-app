      ...
      (
        ...
        >
          ...
          <div style={{
            ...
            borderRadius: 999, background: 'rgba(184,134,11,0.18)', display: 'flex',
          }} />
          <div style={{
            position: 'absolute', bottom: -300, left: -300, width: 700, height: 700,
            borderRadius: 999, background: 'rgba(184,134,11,0.12)', display: 'flex',
          }} />
          ...
          <div style={{
            ...
            <div style={{
              display: 'flex', background: 'rgba(184,134,11,0.95)',
