      ...
      <div className="min-h-screen bg-[#FAFAF7] flex items-center justify-center p-4" dir="rtl">
        <div className="bg-white rounded-3xl p-8 text-center max-w-sm">
          <div className="inline-grid place-items-center w-16 h-16 rounded-2xl bg-[#2B4521]/10 text-[#2B4521] mb-4">
            <Heart className="w-8 h-8 fill-[#2B4521]" />
          </div>
      ...
      <div className="bg-white rounded-3xl p-6 md:p-8 max-w-md w-full">
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 rounded-xl bg-[#FAFAF7] border border-gray-200 text-[#1A2E26] focus:outline-none focus:border-[#2B4521] resize-none text-sm"
          />
        </div>
        ...
        <button
          ...
          className="w-full bg-[#2B4521] text-white rounded-xl px-5 py-3.5 font-black disabled:opacity-50 hover:shadow-md transition-shadow flex items-center justify-center gap-2"
        >
