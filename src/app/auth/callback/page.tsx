        ...
        {error ? (
          <>
            ...
            <button
              ...
              className="bg-[#34D399] text-[#04352A] px-6 py-3 rounded-2xl font-bold shadow-elevated hover:-translate-y-0.5 transition-all"
            >
              ارجع لتسجيل الدخول
            </button>
          </>
          ...
          <>
            <Loader2 className="w-7 h-7 text-[#059669] animate-spin mx-auto mb-4" />
