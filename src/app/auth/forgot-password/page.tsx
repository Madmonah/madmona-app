            ...
            {step === 'phone' && (
              <form onSubmit={(e) => sendCode('whatsapp', e)} className="space-y-5">
                ...
                <button
                  ...
                  disabled={submitting || !phone}
                  className="w-full bg-white border-2 border-gray-100 text-gray-700 py-4 rounded-2xl font-bold text-base hover:border-[#059669]/30 hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:translate-y-0 transition-all flex items-center justify-center gap-2"
                >
