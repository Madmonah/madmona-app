        ...
        <div className="w-full max-w-md animate-slide-up">
          ...
          {stage === 'loading' && (
            <div className="bg-white rounded-3xl shadow-luxe p-10 text-center">
              <Loader2 className="w-8 h-8 text-[#FA8125] animate-spin mx-auto mb-3" />
          ...
          {(stage === 'invalid' || stage === 'expired' || stage === 'used') && (
            <div className="bg-white rounded-3xl shadow-luxe p-8 text-center">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 bg-[#FA8125] text-white px-6 py-3.5 rounded-xl font-bold shadow-elevated hover:shadow-luxe transition-all no-underline"
              >
          ...
          {stage === 'ready' && (
            <>
              ...
              <div className="bg-white rounded-3xl shadow-luxe p-7 md:p-9">
                <div className="mb-4 p-3 bg-[#FA8125]/5 border border-[#FA8125]/15 rounded-xl flex items-start gap-2">
                  <ShieldCheck className="w-4 h-4 text-[#FA8125] flex-shrink-0 mt-0.5" />
                  <p className="text-xs text-[#FA8125]/90 leading-relaxed">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="••••••••"
                        className="w-full px-4 py-3.5 bg-[#FAFAF7] border border-gray-100 rounded-2xl text-base font-medium focus:outline-none focus:bg-white focus:border-[#FA8125]/40 focus:ring-4 focus:ring-[#FA8125]/10 transition-all pl-12"
                        dir="ltr"
