      ...
      <main className="flex-1 flex items-center justify-center p-4 relative z-10">
        <div className="w-full max-w-md animate-slide-up">
                ...
                <form onSubmit={startSignup} className="space-y-5">
                  <div>
                    <label className="text-xs font-bold text-gray-700 mb-2 flex items-center gap-1.5 uppercase tracking-wider">
                      <User className="w-3.5 h-3.5 text-[#FA8125]" />
                      الاسم
                    </label>
                    <input
                      type="text"
          ...
          <p className="text-center text-xs text-gray-500 mt-6">
            ...
            <Link href="/terms" className="text-[#FA8125] font-semibold hover:underline">الشروط</Link>
            {' '}و{' '}
            <Link href="/privacy" className="text-[#FA8125] font-semibold hover:underline">الخصوصية</Link>
          </p>
        </div>
      </main>
    </div>
