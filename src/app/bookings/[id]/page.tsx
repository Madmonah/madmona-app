    ...
    return (
      <div className="min-h-screen bg-[#FAFAF7] flex items-center justify-center p-4" dir={dir}>
        <div className="bg-white rounded-2xl border p-8 text-center max-w-sm">
          ...
          <Link href="/" className="bg-[#2B4521] text-white px-5 py-2.5 rounded-xl font-semibold">
            {t('bdetail.home')}
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7]" dir={dir}>
      ...
      <main className="max-w-2xl mx-auto p-4 pb-12">
        ...
        {showPaymentBlock && (
          <div className="bg-gradient-to-br from-[#2B4521] to-[#5A6E3A] text-white rounded-2xl shadow-elevated overflow-hidden mb-4">
            <div className="p-5">
              ...
              <div className="bg-white/10 backdrop-blur rounded-xl p-3 mb-3 border border-white/15">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 bg-white text-[#2B4521] rounded-lg text-xs font-bold hover:bg-gray-50 flex-shrink-0"
                  >
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-4 mb-4">
          <h3 className="text-base font-bold text-gray-900 mb-3 flex items-center gap-2">
            <Calendar className="w-4 h-4 text-[#2B4521]" /> {t('bdetail.schedule')}
          </h3>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-4 mb-4">
          <h3 className="text-base font-bold text-gray-900 mb-3 flex items-center gap-2">
            <CreditCard className="w-4 h-4 text-[#2B4521]" /> {t('bdetail.price_title')}
          </h3>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
            ...
            <div className="flex justify-between font-bold pt-2 border-t border-gray-100 text-base">
              ...
              <span className="text-[#2B4521]">{Number(booking.total_amount).toLocaleString(lang === 'ar' ? 'ar-EG' : 'en-US')} {booking.currency}</span>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-4 mb-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                disabled={actioning}
                className="bg-[#2B4521] text-white py-2.5 rounded-lg text-sm font-semibold hover:bg-[#2B4521]/90 disabled:opacity-50 flex items-center justify-center gap-1"
              >
        ...
        {isOwnerSupplier && booking.status === 'confirmed' && (
          <div className="bg-white rounded-2xl border border-gray-100 p-4 mb-4">
            <button
              ...
              disabled={actioning}
              className="w-full bg-[#2B4521] text-white py-2.5 rounded-lg text-sm font-semibold hover:bg-[#2B4521]/90 disabled:opacity-50"
            >
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              rows={2}
              maxLength={300}
              className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:bg-white focus:border-[#2B4521]/40 resize-none mb-4"
              autoFocus
            />
            <div className="grid grid-cols-2 gap-2">
              <button
...
function PaymentStep({ num, text }: { num: string; text: string }) {
  return (
    <div className="flex items-start gap-2.5">
      <div className="w-5 h-5 rounded-full bg-white text-[#2B4521] flex items-center justify-center flex-shrink-0 text-[10px] font-black tabular">
        {num}
      </div>
