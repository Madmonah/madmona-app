...
export default function CareersPage() {
      ...
      <div className="min-h-screen bg-[#FAFAF7]" dir="rtl">
        ...
        <main className="max-w-2xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-lg text-gray-700 mb-2">
            شكرًا إنك حابب تنضم لفريق <span className="font-bold text-[#059669]">مضمونة</span>.
          </p>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 mb-6 text-right">
            ...
            <ul className="space-y-2 text-gray-700 text-sm">
              <li className="flex gap-2"><span className="text-[#059669]">•</span> اتأكد إن رقم الواتساب اللي بعتّه شغّال</li>
              <li className="flex gap-2"><span className="text-[#059669]">•</span> لو في CV أو LinkedIn، ابعتهم لنا على واتساب ٠١٠٠٢٢٢٩٩٨٢</li>
              <li className="flex gap-2"><span className="text-[#059669]">•</span> اعرف أكتر عن مضمونة من الموقع الرئيسي</li>
            </ul>
          </div>

          <Link
            href="/"
            className="inline-flex items-center gap-2 bg-[#34D399] text-[#04352A] px-6 py-3 rounded-xl font-bold hover:bg-[#175a4d] transition-colors"
          >
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7]" dir="rtl">
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-sm font-bold text-gray-600 hover:text-[#059669]"
          >
            تواصل معانا
          </a>
        </div>
      ...
      {/* HERO */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#34D399] via-[#34D399] to-[#2FA084] text-white">
              ...
              {SERVICE_VERTICALS.map((s) => (
                <div
                  ...
                  className={`p-5 rounded-2xl border-2 transition-all ${
                    position === s.name ? 'border-[#059669] bg-emerald-50' : 'border-gray-100 bg-white hover:border-emerald-200 hover:shadow-md'
                  }`}
                >
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <span className="text-3xl">{s.icon}</span>
                    <span className="text-[10px] font-bold text-[#059669] bg-emerald-50 border border-emerald-200 px-2 py-1 rounded-full whitespace-nowrap">{s.pay}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="flex-1 bg-[#34D399] text-[#04352A] text-xs font-bold py-2.5 rounded-xl hover:bg-[#185a4f] transition-colors"
                    >
                      قدّم دلوقتي
                    </button>
                    <Link
                      href={`/marketplace?category=${s.slug}`}
                      className="text-xs font-bold text-[#059669] px-3 py-2.5 rounded-xl border border-gray-200 hover:border-[#059669] no-underline whitespace-nowrap transition-colors"
                    >
                      شوف القسم ←
                    </Link>
                  </div>
      ...
      <section id="apply" className="max-w-3xl mx-auto px-4 py-16">
        <div className="bg-white rounded-3xl p-6 md:p-10 border border-gray-100 shadow-sm">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-emerald-50 text-[#059669] px-3 py-1 rounded-full text-sm font-bold mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#059669] focus:border-transparent text-right"
                required
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#059669] focus:border-transparent text-right bg-white"
                required
              >
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#059669] focus:border-transparent"
                  dir="ltr"
                />
              </div>
              <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    max="500000"
                    step="100"
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#059669] focus:border-transparent bg-white"
                    dir="ltr"
                  />
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#059669] focus:border-transparent text-right resize-none"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-gradient-to-l from-[#34D399] to-[#2FA084] text-white px-6 py-4 rounded-xl font-black text-lg hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {submitting ? (
                <>
