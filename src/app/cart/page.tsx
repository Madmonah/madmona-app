      ...
      <div className="min-h-screen gradient-mesh" dir="rtl">
        ...
        <main className="max-w-3xl mx-auto px-4 py-16 text-center">
          <div className="bg-white rounded-3xl shadow-card p-10 max-w-md mx-auto">
            ...
            <Link
              href="/marketplace"
              className="inline-flex items-center gap-2 bg-[#1F6F5F] text-white px-6 py-3 rounded-2xl font-bold shadow-elevated hover:-translate-y-0.5 hover:shadow-luxe transition-all"
            >
              تصفح الماركت بليس
    ...
    <div className="min-h-screen gradient-mesh pb-32 lg:pb-12" dir="rtl">
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 space-y-4">
        ...
        {cart.supplier_name && (
          <div className="bg-white rounded-2xl shadow-soft p-4 flex items-center gap-3 animate-slide-up">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#1F6F5F] to-[#2d7a52] flex items-center justify-center flex-shrink-0">
        ...
        <section className="bg-white rounded-3xl shadow-soft overflow-hidden animate-slide-up delay-100">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <p className="text-sm font-black text-[#1F6F5F] tabular">
          ...
          {/* Subtotal */}
          <div className="bg-gradient-to-l from-[#1F6F5F]/5 to-transparent border-t border-[#1F6F5F]/10 px-4 py-5">
            <div className="flex items-center justify-between">
              <span className="text-sm font-bold text-gray-700">المجموع الفرعي</span>
              <span className="text-2xl font-black text-[#1F6F5F] tabular">
        ...
        <div className="hidden lg:flex justify-between items-center pt-2">
          <Link
            href="/marketplace"
            className="inline-flex items-center gap-2 text-sm font-bold text-gray-600 hover:text-[#1F6F5F] transition-colors"
          >
            <ChevronLeft className="w-4 h-4" />
            كمّل تسوّق
          </Link>
          <button
            ...
            className="inline-flex items-center gap-2 bg-[#1F6F5F] text-white px-8 py-4 rounded-2xl font-bold shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 transition-all"
          >
            كمّل لتأكيد الطلب
            <ChevronLeft className="w-4 h-4" />
          </button>
      ...
      <div className="fixed bottom-0 inset-x-0 glass border-t border-white/40 z-50 lg:hidden shadow-luxe">
        <div className="max-w-3xl mx-auto p-3 flex items-center gap-3">
          ...
          <button
            onClick={() => router.push('/checkout')}
            className="flex items-center gap-1.5 bg-[#1F6F5F] text-white px-6 py-3.5 rounded-2xl font-bold text-sm shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 transition-all"
          >
            تأكيد الطلب
            <ChevronLeft className="w-4 h-4" />
          </button>
