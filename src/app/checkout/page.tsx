      ...
      <main className="max-w-3xl mx-auto px-4 py-6 space-y-4">
        ...
        <section className="bg-white rounded-3xl shadow-soft p-5 animate-slide-up">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/cart" className="text-xs font-bold text-[#FA8125] hover:underline">
              تعديل السلة
            </Link>
          </div>
          {cart.supplier_name && (
        ...
        {!isAuthed && (
          <section className="bg-white rounded-3xl shadow-soft p-5 animate-slide-up delay-75">
            <p className="text-xs text-gray-600 mb-3 leading-relaxed">
              <b className="text-[#FA8125]">عندك حساب أو أول مرة؟</b> ادخل بالواتساب في ثانية —
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-2xl border border-gray-200 focus:border-[#FA8125] focus:ring-2 focus:ring-[#FA8125]/20 outline-none transition-all text-sm font-medium disabled:bg-gray-50 disabled:text-gray-500"
              />
            </div>
            <div>
              <label className="block text-xs font-bold text-gray-600 mb-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  dir="ltr"
                  className="w-full ps-4 pe-10 py-3 rounded-2xl border border-gray-200 focus:border-[#FA8125] focus:ring-2 focus:ring-[#FA8125]/20 outline-none transition-all text-sm font-medium tabular text-right"
                />
              </div>
            </div>
          </div>
        ...
        <section className="bg-white rounded-3xl shadow-soft p-5 animate-slide-up delay-300">
          <h2 className="text-sm font-black text-gray-900 mb-4 flex items-center gap-2">
            <CreditCard className="w-4 h-4 text-[#FA8125]" />
            طريقة الدفع
          </h2>
          <div className="space-y-3">
            ...
            {!foodCodOnly && isAuthed && walletBalance !== null && (
              ...
              >
                ...
                {payment === 'wallet' && <CheckCircle className="w-5 h-5 text-[#FA8125] flex-shrink-0" />}
              </button>
            )}
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-[#FA8125] text-white flex items-center justify-center flex-shrink-0">
              ...
              {payment === 'instapay' && <CheckCircle className="w-5 h-5 text-[#FA8125] flex-shrink-0" />}
            </button>
            )}
            ...
            {codAllowed && (
              ...
              >
                ...
                {payment === 'cod' && <CheckCircle className="w-5 h-5 text-[#FA8125] flex-shrink-0" />}
              </button>
            )}
            ...
            {isAuthed && payment !== 'wallet' && (
              <label className="w-full flex items-center gap-3 p-3 rounded-2xl border border-dashed border-[#2FA084]/50 bg-[#F0F7F4] cursor-pointer">
                ...
                <span className="text-xs text-gray-700 leading-relaxed">
                  <b className="text-[#FA8125]">استخدم رصيد «شير واكسب»</b> لو متاح — خصم تلقائي من إجمالي الطلب (بحد أقصى عمولة مضمونة في الطلب)
                </span>
              </label>
            )}
          </div>
        ...
        {/* Trust note */}
        <div className="bg-gradient-to-l from-[#FA8125]/5 to-transparent border border-[#FA8125]/10 rounded-2xl p-4 flex items-start gap-3">
        ...
        <div className="hidden lg:flex justify-end pt-2">
          <button
            ...
            disabled={submitting}
            className="inline-flex items-center gap-2 bg-[#FA8125] text-white px-10 py-4 rounded-2xl font-bold shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {submitting ? (
              <>
      ...
      <div className="fixed bottom-0 inset-x-0 glass border-t border-white/40 z-50 lg:hidden shadow-luxe">
        <div className="max-w-3xl mx-auto p-3">
          <button
            onClick={handleSubmit}
            disabled={submitting}
            className="w-full flex items-center justify-center gap-2 bg-[#FA8125] text-white py-4 rounded-2xl font-bold shadow-elevated hover:-translate-y-0.5 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {submitting ? (
              <>
