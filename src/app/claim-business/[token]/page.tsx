    ...
    <div dir="rtl" style={{ minHeight: '100dvh', background: '#F7F9F7', color: INK }}>
      ...
      <div style={{ maxWidth: 520, margin: '0 auto', padding: '0 16px 40px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 14, border: `1px solid ${LINE}`, padding: 18 }}>
          ...
          {/* 🔴 (٤ سبتمبر ٢٠٢٦) كان مكتوب «مجاني · مفيش عمولة على مبيعاتك».
              ده **مخالف للنموذج**: العمولة ١٠٪ بعد البيع (اتفاق ٢٠ يوليو).
              وعد كاذب رايح لعميل — خط أحمر: «ممنوع تخترع سعر أو نسبة
              في أي حاجة بتروح لعميل». الصح: التسجيل والعرض مجانيين،
              والعمولة بعد البيع بس. */}
          <p style={{ fontSize: 11, color: MUTED, margin: '12px 0 0', textAlign: 'center' }}>
            التسجيل والعرض مجانًا · عمولة ١٠٪ بعد البيع بس
          </p>
        </div>
      </div>
    </div>
