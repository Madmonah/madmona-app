    ...
    <div dir="rtl" style={{ minHeight: '100dvh', background: '#F7F9F7', color: INK }}>
      ...
      <div style={{ maxWidth: 520, margin: '0 auto', padding: '0 16px 40px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 14, border: `1px solid ${LINE}`, padding: 18 }}>
          ...
          {/* 💰 (٤ سبتمبر ٢٠٢٦) محمد صحّح لي: «العميل ملوش دعوة بالعمولة —
              السعر اللي بيحطه لمضمونة هو اللي بيحصله».
              أنا كنت غيّرت النص لـ«عمولة ١٠٪ بعد البيع» وده **غلط**:
              الـ١٠٪ نصيب مضمونة بتحطه **فوق** سعر البايع في الباكاند
              (قاعدة مقفولة: «العمولة في الباكاند فقط فقط فقط» — ممنوع
              أي ذكر لعمولة في أي شاشة بتروح للمورد).
              البايع بياخد سعره كامل — وده اللي شاشة النجاح بتقوله كمان:
              «والسعر اللي بتطلبه هو اللي بتاخده». */}
          <p style={{ fontSize: 11, color: MUTED, margin: '12px 0 0', textAlign: 'center' }}>
            مجاني · والسعر اللي بتطلبه هو اللي بتاخده
          </p>
        </div>
      </div>
    </div>
