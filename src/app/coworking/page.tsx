...
import {
  ...
  ShieldCheck, Sparkles, Clock, MessageCircle, Star, Building2, GraduationCap, Briefcase,
} from 'lucide-react'
...
const STUDENT_OFFERS = [
  { type: 'Indoor', icon: Building2, price: '60', original: '120', desc: 'مساحة داخلية مكيفة، هادية تماماً للمذاكرة المركزة. مكاتب فردية + قاعات جماعية.' },
  { type: 'Outdoor', icon: Sparkles, price: '32.5', original: '65', desc: 'تيراس مفتوح، طبيعة هادية، مناسب للقراءة والمراجعة في أجواء منعشة.' },
]

const PRO_FEATURES = [
  { icon: Wifi, label: 'Wifi قوي', desc: 'فايبر سرعة عالية لكل الأجهزة' },
  { icon: Coffee, label: 'قهوة وشاي', desc: 'مشروبات ساخنة وباردة مجاناً' },
  { icon: Volume2, label: 'هدوء كامل', desc: 'بيئة شغل خالية من المشتتات' },
  { icon: Users, label: 'قاعات اجتماعات', desc: 'متاحة بالساعة لاجتماعات الفريق' },
]
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl md:text-7xl font-black text-gray-900 leading-[0.95] tracking-tight mb-5">
                ...
                <span className="block italic font-light gradient-text-green">جاهزة دلوقتي</span>
              </h1>
              <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                كوورك سبيس في قلب هليوبوليس. للطلاب، الـfreelancers، والشركات اللي محتاجة مكان شغل محترم.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="text-center mt-10">
              <a href="https://wa.me/201002229982?text=أهلاً!%20عاوز%20أحجز%20كوورك%20بخصم%20الطلاب" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 bg-[#25D366] text-white text-base font-black rounded-2xl shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 transition-all no-underline">
                ...
                <span>احجز خصم الطلاب على واتساب</span>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-[#1F5F3F] to-[#0f3a26] text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-5xl font-black mb-4 leading-tight">
              ...
              <span className="block italic font-light text-white/80">العرض ساري لحد ٣٠ يونيو</span>
            </h2>
            <p className="text-base md:text-lg text-white/85 mb-8 max-w-2xl mx-auto">ابعت رسالة على واتساب الـbusiness دلوقتي ونرتبلك زيارة تجريبية مجاناً قبل ما تحجز.</p>
            ...
            <p className="text-xs text-white/60 mt-8">٧ شارع سليمان عزمي، النزهة، مصر الجديدة، القاهرة</p>
          </div>
        </section>
      </main>
      <BottomNav />
