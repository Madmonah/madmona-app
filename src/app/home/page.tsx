        ...
        {admins.length > 0 && (
          <section>
            ...
            <div className="space-y-2">
              {admins.map((a: any) => (
                <Link key={a.supplier_id} href={`/owner/${a.supplier_id}`} className="bg-white rounded-2xl border border-gray-100 p-4 flex items-center justify-between hover:border-[#1F6F5F] hover:shadow-md transition-all">
