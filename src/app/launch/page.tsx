...
export default function LaunchPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#FA8125]/5 via-white to-[#2FA084]/5" dir="rtl">
        <TopNav />
        <main className="max-w-2xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            ...
            <br />
            {type === 'customer' ? (
              <span className="font-bold text-[#FA8125]">عرضك جاهز: كاش باك ٥٠ ج على أول حجز 💚</span>
            ) : (
          ...
          <div className="bg-white rounded-3xl shadow-luxe p-6 mb-6">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              ...
              <Link
                href="/marketplace"
                className="inline-flex items-center gap-2 bg-[#FA8125] text-white px-5 py-2.5 rounded-full font-bold text-sm hover:scale-105 transition-transform no-underline"
              >
  ...
  const customerBenefits = [
    {
      ...
      color: 'bg-[#FA8125]/10 text-[#FA8125]',
      title: 'كاش باك ٥٠ ج',
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto mb-8">
            <div className="bg-gradient-to-br from-[#FA8125] to-[#F98F2A] text-white rounded-2xl p-4 shadow-elevated">
          ...
          {signupCount !== null && (
            <p className="text-sm text-gray-500 flex items-center justify-center gap-2">
              ...
              <span>
                <span className="font-black text-[#FA8125]">{signupCount.toLocaleString('ar-EG')}</span>
                {' '}مصري سجل قبلك
              </span>
            </p>
          )}
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#FAFAF7] border border-gray-100 rounded-xl text-sm focus:outline-none focus:bg-white focus:border-[#FA8125]/40"
                />
              </div>
