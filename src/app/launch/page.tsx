...
export default function LaunchPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#34D399]/5 via-white to-[#2FA084]/5" dir="rtl">
        <TopNav />
        <main className="max-w-2xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            ...
            <br />
            {type === 'customer' ? (
              <span className="font-bold text-[#059669]">عرضك جاهز: كاش باك ٥٠ ج على أول حجز 💚</span>
            ) : (
          ...
          <div className="bg-white rounded-3xl shadow-luxe p-6 mb-6">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              ...
              <Link
                href="/marketplace"
                className="inline-flex items-center gap-2 bg-[#34D399] text-[#04352A] px-5 py-2.5 rounded-full font-bold text-sm hover:scale-105 transition-transform no-underline"
              >
  ...
  const customerBenefits = [
    {
      ...
      color: 'bg-[#34D399]/10 text-[#059669]',
      title: 'كاش باك ٥٠ ج',
  ...
  const supplierBenefits = [
    {
      ...
      color: 'bg-[#2FA084]/10 text-[#2FA084]',
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto mb-8">
            <div className="bg-gradient-to-br from-[#34D399] to-[#34D399] text-white rounded-2xl p-4 shadow-elevated">
            ...
            <div className="bg-gradient-to-br from-[#2FA084] to-[#D4A12A] text-white rounded-2xl p-4 shadow-elevated">
          ...
          {signupCount !== null && (
            <p className="text-sm text-gray-500 flex items-center justify-center gap-2">
              ...
              <span>
                <span className="font-black text-[#059669]">{signupCount.toLocaleString('ar-EG')}</span>
                {' '}مصري سجل قبلك
              </span>
            </p>
          )}
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-luxe p-6 md:p-8 order-2 md:order-1">
            <div className="text-center mb-6">
              <div className="inline-flex items-center gap-2 bg-[#2FA084]/10 text-[#2FA084] px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase mb-3">
            ...
            <div className="grid grid-cols-2 gap-2 mb-5">
              ...
              <button
                ...
                className={`p-3 rounded-2xl border-2 font-bold text-sm transition-all ${
                  type === 'supplier'
                    ? 'border-[#2FA084] bg-[#2FA084]/5 text-[#2FA084]'
                    : 'border-gray-200 text-gray-500 hover:border-gray-300'
                }`}
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#FAFAF7] border border-gray-100 rounded-xl text-sm focus:outline-none focus:bg-white focus:border-[#059669]/40"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={submitting}
                className={`w-full text-[#04352A] font-bold py-4 rounded-2xl flex items-center justify-center gap-2 disabled:opacity-50 transition-all shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 ${
                  type === 'customer'
