  ...
  return (
    <div className="min-h-screen gradient-mesh pb-12" dir="rtl">
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 space-y-4">
        ...
        <section className="bg-white rounded-3xl shadow-card overflow-hidden animate-slide-up">
          <div className={`p-6 text-center border-b-4 ${
            ...
            >
              ...
              <Copy className="w-4 h-4 text-gray-400 group-hover:text-[#1F6F5F]" />
            </button>
                  ...
                  return (
                    <div key={step} className={`flex items-center gap-3 transition-all ${
                      ...
                      <div className={`w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 ${
                        ...
                        isCurrent ? 'bg-[#1F6F5F] text-white shadow-md scale-110' :
                        'bg-gray-100 text-gray-400'
                      }`}>
                        {isPast ? <CheckCircle className="w-4 h-4" /> : <StepIcon className="w-4 h-4" />}
                      </div>
                      <div className="flex-1">
                        <p className={`text-sm font-bold ${isCurrent ? 'text-[#1F6F5F]' : isPast ? 'text-gray-700' : 'text-gray-400'}`}>
                          {stepMeta.label}
                        </p>
                        {ts && (
            ...
            <div className="p-5 space-y-3">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl">
                <div>
                  ...
                  <p className="text-lg font-black text-[#1F6F5F] tabular">
            ...
            {order.items.map((item) => (
              <div key={item.id} className="p-4 flex gap-3">
                ...
                <div className="text-left flex-shrink-0">
                  <p className="font-black text-sm text-[#1F6F5F] tabular">
        ...
        <div className="bg-gradient-to-l from-[#1F6F5F]/5 to-transparent border border-[#1F6F5F]/10 rounded-2xl p-4">
