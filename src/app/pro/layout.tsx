...
export const metadata: Metadata = {
  title: 'برنامج إدارة البيزنس بـ١٠٠٠ ج بدل كتير — حسابات · CRM · موظفين · بوت واتساب',
  ...
  openGraph: { title: 'برنامج إدارة البيزنس بـ١٠٠٠ ج بدل كتير', description: 'حسابات · CRM · موظفين وحضور · مخزون · بوت واتساب · صفحتك — من موبايلك.', url: 'https://www.madmonacairo.com/pro', siteName: 'مضمونة', locale: 'ar_EG', type: 'website' },
}
