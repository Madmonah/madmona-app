  ...
  return (
    <main dir="rtl" className="min-h-screen bg-[#FAFAF7] text-[#1A2E26]">
      ...
      <section className="mx-auto max-w-3xl px-5 pb-10">
        ...
        {/* محمد (٧/٩): «فين حجز الخدمات زي فيزيتا وحجز برامج الصالون والبيوتي؟» — الحجوزات
            عندنا ٣ أنواع فعلًا (إيجار/شاليهات · عيادات per_session · صالونات per_service) فبقوا ٣ كروت */}
        <h2 className="text-xl font-black mb-1">مضمونة = <span className="text-[#059669]">١٢ أبليكيشن</span> في واحد</h2>
        <p className="text-xs text-gray-500 mb-4">بدل ما تشترك في ١٢ برنامج وتربطهم بإيدك — كلهم على نفس الداتا ونفس الرقم.</p>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center">
          {[
            ['🛒', 'أمازون', 'سوق بيع'], ['🏖️', 'بوكينج', 'إيجار وشاليهات'], ['🩺', 'فيزيتا', 'حجز عيادات'], ['💇', 'فريشا', 'حجز صالون وبيوتي'],
            ['🍽️', 'طلبات', 'منيو QR وأوردرات'], ['🛵', 'أوبر', 'دليفري بطيارين'], ['📒', 'أودو', 'حسابات ومخزون'], ['📇', 'هابسبوت', 'CRM وليدات'],
            ['🕘', 'بامبو HR', 'موظفين وحضور ومرتبات'], ['🤖', 'واتساب بيزنس', 'بوت بيرد بدالك'], ['💼', 'أب وورك', 'خدمات ومحترفين'], ['🌐', 'شوبيفاي', 'موقع لبيزنسك'],
          ].map(([e, brand, l]) => (
