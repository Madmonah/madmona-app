    ...
    <div className="min-h-screen bg-[#FAFAF7]" dir="rtl">
      ...
      <main className="max-w-4xl mx-auto px-4 pb-24">
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-sm text-gray-600 hover:text-[#059669] mt-5 mb-4 transition-colors"
        >
        ...
        <section className="mt-6">
          <div className="flex flex-wrap items-center gap-2 mb-3">
            {type && (
              <span className="inline-flex items-center gap-1 text-xs font-semibold bg-[#34D399]/10 text-[#059669] px-2.5 py-1 rounded-full">
          ...
          {price && <p className="mt-4 text-xl font-bold text-[#059669]">{price}</p>}
        </section>
        ...
        {p.brochure_url && (
          <a
            ...
            target="_blank"
            rel="noopener"
            className="mt-5 flex items-center justify-center gap-2 w-full bg-white border-2 border-[#059669]/20 text-[#059669] font-semibold py-3.5 rounded-2xl hover:bg-[#34D399]/5 hover:border-[#059669]/40 transition-all"
          >
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          className="mt-3 flex items-center justify-center gap-2 w-full bg-[#34D399] text-[#04352A] font-bold py-4 rounded-2xl hover:bg-[#175a4d] shadow-sm hover:shadow-md transition-all"
        >
