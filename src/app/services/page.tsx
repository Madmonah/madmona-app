  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7] text-right pb-20 md:pb-0" dir="rtl">
      ...
      <main className="relative">
        {/* HERO */}
        <section className="relative py-12 md:py-20 bg-gradient-to-br from-[#34D399]/5 via-[#FAFAF7] to-[#2FA084]/5">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white shadow-soft border border-gray-100 mb-5">
              ...
              <span className="text-[10px] md:text-xs font-bold tracking-[0.3em] uppercase text-[#059669]">خدمات مضمونة</span>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 mt-8">
              <Link
                href="/marketplace"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#34D399] text-[#04352A] font-black rounded-full shadow-elevated hover:-translate-y-0.5 transition-all no-underline"
              >
              ...
              {RENTAL_CATEGORIES.map((cat) => {
                ...
                return (
                  <Link
                    ...
                    className="group bg-[#FAFAF7] hover:bg-white border border-gray-100 hover:border-[#059669]/20 hover:shadow-elevated rounded-2xl p-6 transition-all no-underline"
                  >
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-[#34D399]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#34D399]/20 group-hover:scale-105 transition-all">
                        <Icon className="w-6 h-6 text-[#059669]" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="font-black text-gray-900 text-lg mb-1.5 group-hover:text-[#059669] transition-colors">
                          {cat.name}
                        </h3>
                        <p className="text-sm text-gray-600 leading-relaxed">{cat.desc}</p>
                        <div className="inline-flex items-center gap-1 mt-3 text-xs font-bold text-[#059669] group-hover:gap-2 transition-all">
                          <span>اتصفح</span>
        ...
        <section className="py-14 md:py-20 bg-gradient-to-br from-[#34D399]/5 to-[#2FA084]/5">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              <p className="text-[10px] md:text-xs font-bold tracking-[0.3em] uppercase text-[#059669] mb-3">تجربة الحجز</p>
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              {NEWS_FEATURES.map((f) => {
                const Icon = f.icon
                return (
                  <div key={f.name} className="border border-gray-100 rounded-2xl p-6 hover:border-[#059669]/20 hover:shadow-soft transition-all">
                    <div className="w-12 h-12 rounded-2xl bg-[#34D399]/10 flex items-center justify-center mb-4">
                      <Icon className="w-6 h-6 text-[#059669]" />
                    </div>
                    <h3 className="font-black text-gray-900 text-lg mb-2">{f.name}</h3>
                    <p className="text-sm text-gray-600 leading-relaxed">{f.desc}</p>
