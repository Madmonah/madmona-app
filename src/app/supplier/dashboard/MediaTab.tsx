...
export default function MediaTab({ supplier, branches, employees, onSaved }: Props) {
  ...
  return (
    <section dir="rtl">
      ...
      <style jsx>{`
        .mt-intro { font-size: 13px; color: #41504A; line-height: 1.7; background: linear-gradient(135deg, rgba(212,160,23,.07), rgba(47,160,132,.07)); border: 1px solid rgba(250, 129, 37,.15); border-radius: 12px; padding: 12px 14px; margin: 0 0 22px; }
        ...
        .mt-btn { font-family: inherit; font-size: 13px; font-weight: 700; padding: 9px 14px; border-radius: 10px; border: 1px solid rgba(250, 129, 37,.3); background: white; color: #059669; cursor: pointer; display: inline-flex; align-items: center; gap: 7px; align-self: flex-start; }
        .mt-btn:hover { background: #F3F7F5; }
        .mt-btn-primary { background: linear-gradient(100deg,#d4a017,#2FA084 55%,#059669); color: white; border: none; }
        ...
        .mt-gal-add { width: 116px; height: 88px; border-radius: 12px; border: 2px dashed rgba(250, 129, 37,.3); background: #FAFAF7; color: #059669; font-size: 12px; font-weight: 700; cursor: pointer; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 4px; }
        ...
        .mt-thumb { width: 52px; height: 52px; border-radius: 10px; background-size: cover; background-position: center; background-image: linear-gradient(135deg,rgba(250, 129, 37,.12),rgba(212,160,23,.14)); display: grid; place-items: center; color: #059669; flex: none; }
        .mt-row-name { flex: 1; font-size: 14px; font-weight: 800; min-width: 0; }
        .mt-grp { margin-bottom: 18px; }
        .mt-grp-h { font-size: 12px; font-weight: 800; color: #059669; margin-bottom: 10px; }
        ...
        .mt-emp-cam { position: absolute; bottom: -2px; left: -2px; width: 24px; height: 24px; border-radius: 50%; background: #059669; color: white; display: grid; place-items: center; border: 2px solid white; }
