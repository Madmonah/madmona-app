...
.sd-spinner { width: 36px; height: 36px; border: 3px solid #E7F1ED; border-top-color: #1F6F5F; border-radius: 50%; animation: sd-spin 1s linear infinite; }
...
.sd-logo-placeholder { background: linear-gradient(135deg, #D4A017, #2FA084, #1F6F5F); color: white; display: grid; place-items: center; font-weight: 800; font-size: 20px; }
...
.sd-tab:hover { color: #1F6F5F; }
.sd-tab.on { color: #1F6F5F; border-bottom-color: #1F6F5F; }
...
.sd-stat-num { font-size: 22px; font-weight: 800; color: #1F6F5F; }
...
.sd-step:hover { background: #F3F1EA; border-color: rgba(31,111,95,.2); }
.sd-step.done { background: #D1FAE5; opacity: .8; }
.sd-step-num { width: 28px; height: 28px; border-radius: 50%; background: white; display: grid; place-items: center; font-weight: 800; font-size: 13px; color: #1F6F5F; border: 1px solid rgba(31,111,95,.2); flex: none; }
.sd-step.done .sd-step-num { background: #1F6F5F; color: white; }
.sd-step > span:nth-child(2) { flex: 1; font-size: 13.5px; font-weight: 700; }
.sd-step-arrow { color: #1F6F5F; font-weight: 800; }
.sd-callout { background: linear-gradient(135deg, rgba(212,160,23,.08), rgba(47,160,132,.08)); border: 1px solid rgba(31,111,95,.15); border-radius: 16px; padding: 22px; }
...
.sd-row-avatar { width: 40px; height: 40px; border-radius: 10px; background: linear-gradient(135deg, #E7F1ED, #FAFAF7); display: grid; place-items: center; font-weight: 800; font-size: 16px; color: #1F6F5F; flex: none; }
...
.sd-row-meta .sd-price { color: #1F6F5F; font-weight: 800; }
...
.sd-btn-primary { background: #1F6F5F; color: white; }
.sd-btn-primary:hover { background: #175C4F; }
.sd-btn-outline { border-color: rgba(31,111,95,.3); color: #1F6F5F; }
...
.sd-form-divider { font-size: 11px; font-weight: 800; color: #1F6F5F; letter-spacing: .08em; padding: 8px 0 0; border-top: 1px dashed rgba(10,10,10,.1); margin-top: 4px; }
...
.sd-field input:focus, .sd-field select:focus, .sd-field textarea:focus { outline: 2px solid #1F6F5F; border-color: #1F6F5F; }
`
