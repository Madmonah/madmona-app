    ...
    <div className="min-h-screen bg-[#FAFAF7]" dir="rtl">
      ...
      <main className="max-w-md mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm text-center">
          <div className="flex items-center justify-center w-14 h-14 bg-[#1F5F3F]/10 rounded-full mx-auto mb-4">
            <Clock className="w-7 h-7 text-[#1F5F3F]" />
          </div>
          ...
          <div className="bg-[#FAFAF7] rounded-xl p-4 mb-6 text-right">
            <h3 className="font-semibold text-gray-900 mb-3 flex items-center gap-2 justify-end">
              ...
              <CheckCircle className="w-4 h-4 text-[#1F5F3F]" />
            </h3>
            <ol className="space-y-2 text-sm text-gray-700">
              <li className="flex gap-2">
                <span className="font-bold text-[#1F5F3F]">١.</span>
                <span>هنراجع طلبك خلال ٢٤ ساعة</span>
              </li>
              <li className="flex gap-2">
                <span className="font-bold text-[#1F5F3F]">٢.</span>
                <span>هنتواصل معاك لتأكيد البيانات</span>
              </li>
              <li className="flex gap-2">
                <span className="font-bold text-[#1F5F3F]">٣.</span>
                <span>هنضيف وحداتك على الموقع</span>
              </li>
              <li className="flex gap-2">
                <span className="font-bold text-[#1F5F3F]">٤.</span>
