...
.sd-spinner { width: 36px; height: 36px; border: 3px solid #E7F1ED; border-top-color: #059669; border-radius: 50%; animation: sd-spin 1s linear infinite; }
...
.sd-logo-placeholder { background: linear-gradient(135deg, #D4A017, #2FA084, #059669); color: white; display: grid; place-items: center; font-weight: 800; font-size: 20px; }
...
.sd-tab.on { color: #059669; border-bottom-color: #059669; }
...
.sd-stat-num { font-size: 22px; font-weight: 800; color: #059669; }
...
.sd-step-num { width: 28px; height: 28px; border-radius: 50%; background: white; display: grid; place-items: center; font-weight: 800; font-size: 13px; color: #059669; border: 1px solid rgba(250, 129, 37,.2); flex: none; }
.sd-step.done .sd-step-num { background: #059669; color: white; }
.sd-step > span:nth-child(2) { flex: 1; font-size: 13.5px; font-weight: 700; }
.sd-step-arrow { color: #059669; font-weight: 800; }
...
.sd-row-avatar { width: 40px; height: 40px; border-radius: 10px; background: linear-gradient(135deg, #E7F1ED, #FAFAF7); display: grid; place-items: center; font-weight: 800; font-size: 16px; color: #059669; flex: none; }
...
.sd-row-meta .sd-price { color: #059669; font-weight: 800; }
...
.sd-btn-primary { background: #059669; color: white; }
.sd-btn-primary:hover { background: #175C4F; }
.sd-btn-outline { border-color: rgba(250, 129, 37,.3); color: #059669; }
...
.sd-form-divider { font-size: 11px; font-weight: 800; color: #059669; letter-spacing: .08em; padding: 8px 0 0; border-top: 1px dashed rgba(10,10,10,.1); margin-top: 4px; }
...
.sd-field input:focus, .sd-field select:focus, .sd-field textarea:focus { outline: 2px solid #059669; border-color: #059669; }
`
