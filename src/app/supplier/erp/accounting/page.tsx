...
export default function ErpAccountingPage() {
  ...
  // ---------- UI ----------
  const card: React.CSSProperties = { background: 'rgba(255,255,255,.85)', backdropFilter: 'blur(8px)', borderRadius: 20, padding: 20, boxShadow: '0 4px 24px rgba(31,111,95,.08)', border: '1px solid rgba(31,111,95,.1)' };
  ...
  const inp: React.CSSProperties = { border: `1px solid rgba(31,111,95,.25)`, borderRadius: 12, padding: '8px 12px', fontFamily: 'inherit', background: '#fff', width: '100%' };
