        ...
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center gap-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <button onClick={() => copyToClipboard(order.reference_code, 'ref')} className="flex items-center gap-1 group">
              ...
              <Copy className="w-3 h-3 text-gray-400 group-hover:text-[#059669]" />
            </button>
          </div>
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 space-y-4">
            ...
            {order.delivery_phone && (
              <div className="flex items-center justify-between gap-2 p-2 bg-gray-50 rounded-xl">
                ...
                <button
                  ...
                  className="text-sm font-bold tabular text-gray-900 hover:text-[#059669]"
                  dir="ltr"
                >
        ...
        <section className="bg-white rounded-3xl shadow-soft p-5 animate-slide-up delay-300">
          ...
          <textarea
            ...
            rows={2}
            className="w-full px-4 py-3 rounded-2xl border border-gray-200 focus:border-[#059669] focus:ring-2 focus:ring-[#059669]/20 outline-none transition-all text-sm font-medium resize-none mb-2"
          />
          <div className="flex justify-end">
            <button
              onClick={saveSupplierNotes}
              disabled={notesSaving}
              className="text-xs font-bold text-[#059669] px-4 py-2 rounded-xl hover:bg-[#34D399]/10 disabled:opacity-60 transition-all"
            >
          ...
          <div className="hidden lg:flex gap-2 pt-2">
            {action && (
              <button
                ...
                disabled={updating}
                className="flex-1 inline-flex items-center justify-center gap-2 bg-[#34D399] text-[#04352A] px-6 py-4 rounded-2xl font-bold shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 transition-all disabled:opacity-60"
              >
          ...
          <div className="max-w-3xl mx-auto p-3 flex gap-2">
            {action && (
              <button
                onClick={() => advanceStatus(action.next)}
                disabled={updating}
                className="flex-1 inline-flex items-center justify-center gap-2 bg-[#34D399] text-[#04352A] py-4 rounded-2xl font-bold shadow-elevated disabled:opacity-60"
              >
                {updating ? <Loader2 className="w-4 h-4 animate-spin" /> : <action.icon className="w-4 h-4" />}
                {action.label}
              </button>
