            ...
            >
              ...
              {unansweredCount > 0 && (
                <span className={`rounded-full px-1.5 text-[10px] font-bold ${
                  filter === 'unanswered' ? 'bg-white text-[#1F5F3F]' : 'bg-yellow-400 text-gray-900'
                }`}>
                  {unansweredCount}
                </span>
              )}
                  ...
                  {review.listing && (
                    <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 border-b border-gray-100">
                      ...
                      <Link
                        ...
                        target="_blank"
                        className="flex-1 text-xs font-medium text-gray-700 hover:text-[#1F5F3F] truncate"
                      >
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex items-center gap-0.5">
                        {[1, 2, 3, 4, 5].map(s => (
                          <Star
                            key={s}
                            className={`w-3.5 h-3.5 ${s <= review.rating ? 'fill-[#B8860B] text-[#B8860B]' : 'text-gray-200'}`}
                          />
                        ))}
                      </div>
                    </div>
                    ...
                    {isEditing ? (
                      <div className="bg-[#1F5F3F]/5 border border-[#1F5F3F]/20 rounded-xl p-3 mt-3">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-xs font-semibold text-[#1F5F3F]">ردك كـ{supplierName}</span>
                        </div>
                        <textarea
                          value={responseText}
                          ...
                          maxLength={1000}
                          rows={3}
                          className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1F5F3F]/30 focus:border-[#1F5F3F] resize-y"
                          autoFocus
                        />
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="flex items-center gap-1 px-3 py-1.5 bg-[#1F5F3F] text-white rounded-lg text-xs font-semibold hover:bg-[#1F5F3F]/90 disabled:opacity-50"
                            >
