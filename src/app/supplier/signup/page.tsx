    ...
    return (
      <div className="min-h-screen bg-[#FAFAF7] flex items-center justify-center px-6 py-8" dir="rtl">
        <div className="max-w-md w-full bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
          <div className="flex items-center justify-center w-14 h-14 bg-[#34D399]/10 rounded-full mx-auto mb-5">
          ...
          <Link href="/" className="block text-center text-sm text-[#059669] hover:underline">
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7]" dir="rtl">
      ...
      <main className="max-w-md mx-auto px-4 py-6 pb-12">
        {/* Hero pitch */}
        <section className="mb-6 bg-gradient-to-br from-[#34D399] to-[#34D399]/90 text-white rounded-2xl p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input type="text" value={businessName} onChange={(e) => setBusinessName(e.target.value)} placeholder="مثال: WorkStation Cairo" className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669] text-right" />
          </div>
          ...
          <div>
            ...
            <input type="text" value={contactName} onChange={(e) => setContactName(e.target.value)} placeholder="اسمك بالكامل" className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669] text-right" autoComplete="name" />
          </div>
          ...
          <div>
            ...
            <input type="tel" value={contactPhone} onChange={(e) => setContactPhone(e.target.value.replace(/[^\d+]/g, '').slice(0, 14))} placeholder="01xxxxxxxxx" className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669]" dir="ltr" style={{ textAlign: 'right' }} autoComplete="tel" inputMode="tel" />
          </div>
          ...
          <div>
            ...
            <input type="email" value={contactEmail} onChange={(e) => setContactEmail(e.target.value)} placeholder="email@example.com" className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669]" dir="ltr" style={{ textAlign: 'right' }} autoComplete="email" />
          </div>
          ...
          <div>
            ...
            <input type="text" value={district} onChange={(e) => setDistrict(e.target.value)} placeholder="مثال: مصر الجديدة، الزمالك، التجمع الخامس..." className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669] text-right" />
          </div>
          ...
          <div>
            ...
            <input type="text" value={address} onChange={(e) => setAddress(e.target.value)} placeholder="رقم الشارع، المنطقة، علامة مميزة..." className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669] text-right" />
          </div>
          ...
          <div>
            ...
            <textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="إيه المساحة بتاعتك بتقدمه؟ كم مكتب؟ كم غرفة اجتماعات؟" rows={3} className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669] text-right resize-none" />
          </div>
          ...
          <button type="button" onClick={handleSubmit} disabled={!canSubmit} className="w-full bg-[#34D399] text-[#04352A] py-3.5 px-6 rounded-xl font-semibold hover:bg-[#34D399]/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors mt-2">
