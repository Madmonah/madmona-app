  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-100 p-6 shadow-[0_10px_40px_-12px_rgba(43, 69, 33,0.25)]">
      <div className="text-center mb-6">
        <div className="w-14 h-14 rounded-2xl bg-[#2B4521]/10 grid place-items-center mx-auto mb-3"><MessageCircle className="w-7 h-7 text-[#2B4521]" /></div>
      ...
      <div className="relative mb-4">
        ...
        <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder={t('gate.name_ph')} className="w-full pr-10 pl-3 py-3.5 rounded-2xl bg-[#FAFAF7] border border-transparent text-sm outline-none focus:border-[#2B4521]/40 focus:bg-white transition-colors" />
      </div>
