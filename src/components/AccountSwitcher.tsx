  ...
  return (
    <div className="bg-white rounded-3xl shadow-soft p-5 md:p-6">
      <div className="flex items-center gap-3 mb-4">
        <div className="w-10 h-10 rounded-2xl bg-[#34D399]/10 flex items-center justify-center flex-shrink-0">
      ...
      {currentPhone && (
        <div className="bg-[#34D399]/5 border border-[#059669]/20 rounded-2xl p-3 mb-3 flex items-center gap-3">
          ...
          <span className="text-[10px] font-black text-[#059669] bg-white px-2 py-1 rounded-full whitespace-nowrap">
                ...
                {isRemoving ? (
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="inline-flex items-center gap-1 bg-[#34D399] hover:bg-[#34D399]/90 text-[#04352A] text-xs font-bold px-3 py-1.5 rounded-lg disabled:opacity-50 transition-colors"
                    >
                      {isSwitching ? (
                        <>
      ...
      {currentPhone ? (
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-200 hover:border-[#059669] hover:bg-[#34D399]/5 hover:text-[#059669] text-gray-600 rounded-2xl text-sm font-bold transition-all"
        >
        ...
        <Link
          href="/auth/login"
          className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-[#34D399] text-[#04352A] rounded-2xl text-sm font-bold no-underline hover:bg-[#34D399]/90 transition-colors"
        >
          <Plus className="w-4 h-4" />
