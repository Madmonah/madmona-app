...
const NAV: NavGroup[] = [
  ...
  // 📇 (٢٢ أغسطس ٢٠٢٦) CRM مضمونة — توزيع الأرقام بالتخصص، تفريغ المكالمات،
  //    والتاسكات اللي بتتحوّل لوحدها. محمد: «مش شايف تاب الـCRM لا في الأدمن
  //    ولا في أي مكان».
  //    🐞 والسبب إني حطّيتها يوم ٢١ في `AdminNav.tsx` — وده كومبوننت
  //       **مش مرندر في أي مكان خالص** (اتأكدت بالبحث في كل src). التنقّل
  ...
  /* ➕ (٢٤ أغسطس ٢٦) محمد: «فين تاب إضافة الإعلان — عايزه في التاب اللي على اليمين».
     تاب مستقل بيوصّل مباشرةً على مودال «ضيف إعلان» في نفس صفحة الإعلانات. */
  { href: '/admin/listings?add=1', label: '➕ ضيف إعلان' },
    // ⏸️ (٢٢ أغسطس ٢٠٢٦) نفس الحكاية — «الإعلانات الواقفة» اتبنت يوم ٢١
    //    وحطّيتها في AdminNav الميت. دي مكانها الصح.
