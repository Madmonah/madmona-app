...
export default function CartButton({
  ...
  return (
    ...
    >
      ...
      <span className="absolute -top-1.5 ltr:-right-1.5 rtl:-left-1.5 min-w-[18px] h-[18px] px-1 rounded-full bg-[#FA8125] text-white text-[10px] font-black flex items-center justify-center shadow-soft">
        {count > 99 ? '99+' : count}
      </span>
    </Link>
  )
