...
// أبيض نضيف، التاب النشط أخضر #2B4521 بنقطة صغيرة، والباقي رمادي #8A9690.
      ...
      {TABS.map((t) => {
        ...
        return (
          <Link
            key={t.href}
            href={t.href}
            style={{ flex: 1, textAlign: 'center', padding: '8px 0 9px', textDecoration: 'none', color: active ? '#2B4521' : '#8A9690', position: 'relative' }}
          >
