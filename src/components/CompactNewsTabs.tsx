...
export default function CompactNewsTabs() {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-elevated overflow-hidden border border-gray-100">
      {/* Header */}
      <div className="bg-gradient-to-l from-[#34D399] via-[#268a70] to-[#34D399] px-4 md:px-5 py-3 flex items-center justify-between">
      ...
      {loading && cards.length === 0 ? (
        ...
        <div className="p-16 text-center">
          ...
          <button
            onClick={() => fetchAll()}
            className="mt-4 text-xs font-bold text-[#059669] hover:underline inline-flex items-center gap-1 mx-auto"
          >
