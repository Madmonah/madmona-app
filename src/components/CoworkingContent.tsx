  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7] overflow-x-hidden pb-20 md:pb-0" dir={dir}>
      ...
      <main className="relative">
        <section className="relative pt-8 pb-12 md:pt-16 md:pb-20 bg-gradient-to-br from-[#34D399]/8 via-[#FAFAF7] to-[#2FA084]/8 overflow-hidden">
          <div className="absolute -top-20 -right-20 w-96 h-96 bg-[#2FA084]/10 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 -left-20 w-72 h-72 bg-[#34D399]/10 rounded-full blur-3xl pointer-events-none" />
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white shadow-soft border border-gray-100 mb-5">
                ...
                <span className="text-[10px] md:text-xs font-bold tracking-[0.3em] uppercase text-[#059669]">{t('cowork.exclusive')}</span>
              </div>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#34D399]/10 mb-4">
                <GraduationCap className="w-4 h-4 text-[#059669]" />
                <span className="text-xs font-black tracking-widest uppercase text-[#059669]">{t('cowork.students_badge')}</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
              {STUDENT_OFFERS.map((offer, i) => {
                ...
                return (
                  <div key={i} className="relative bg-gradient-to-br from-[#34D399]/5 to-[#FAFAF7] border border-[#059669]/15 rounded-3xl p-7 md:p-8 hover:shadow-card transition-all">
                    ...
                    <div className="w-14 h-14 rounded-2xl bg-[#34D399]/10 flex items-center justify-center mb-5"><Icon className="w-7 h-7 text-[#059669]" /></div>
                    ...
                    <div className="flex items-baseline gap-3">
                      <span className="text-4xl md:text-5xl font-black text-[#059669]">{offer.price}</span>
        ...
        <section className="py-12 md:py-16 bg-[#FAFAF7]">
          <div className="max-w-7xl mx-auto px-4">
              ...
              {PRO_FEATURES.map((f, i) => {
                ...
                return (
                  <div key={i} className="bg-white rounded-2xl p-5 text-center border border-gray-100 hover:shadow-card transition-all">
                    <div className="w-12 h-12 rounded-2xl bg-[#34D399]/10 flex items-center justify-center mx-auto mb-3"><Icon className="w-6 h-6 text-[#059669]" /></div>
            ...
            <div className="text-center">
              <a href="https://wa.me/201002229982?text=أهلاً!%20عاوز%20أحجز%20كوورك%20بـ120%20جنيه" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 bg-[#34D399] text-[#04352A] text-base font-black rounded-2xl shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 transition-all no-underline">
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-[#34D399] to-[#0f3a26] text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              ...
              <a href="https://share.google/QbWskGlQ49AUTJrTc" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[#059669] text-base font-black rounded-2xl shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 transition-all no-underline">
