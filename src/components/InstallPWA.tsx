...
export default function InstallPWA() {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-[#1F6F5F] to-[#2a7a52] rounded-2xl p-4 mb-6 flex items-center gap-3 shadow-sm">
        ...
        >
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-[#1F6F5F]/10 flex items-center justify-center">
