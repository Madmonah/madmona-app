...
function MUABannerInner() {
  ...
  return (
    <div
      className={`relative bg-gradient-to-br from-[#34D399] via-[#34D399] to-[#34D399] text-white overflow-hidden transition-all duration-300 ${
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-5 md:py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mt-4">
          ...
          <Link
            ...
            className="group flex items-center gap-3 bg-white text-[#059669] hover:bg-gray-50 p-4 rounded-2xl no-underline shadow-soft hover:shadow-elevated hover:-translate-y-0.5 transition-all"
          >
            <div className="w-11 h-11 rounded-xl bg-[#34D399]/10 flex items-center justify-center flex-shrink-0">
            ...
            <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform flex-shrink-0 text-[#059669]" />
          </Link>
        </div>
