            ...
            return (
              <button
                ...
                className={`flex-shrink-0 flex items-center gap-2 px-4 md:px-5 py-2.5 md:py-3 rounded-full text-sm font-bold transition-all duration-300 ${
                  isActive
                    ? 'bg-[#34D399] text-[#04352A] shadow-elevated scale-105'
              ...
              >
                ...
                {items[tab.id].length > 0 && !isActive && (
                  <span className="text-[10px] bg-[#34D399]/10 text-[#059669] px-1.5 py-0.5 rounded-full font-black">
                    {items[tab.id].length}
                  </span>
                )}
              </button>
        ...
        {hasError && currentItems.length === 0 && (
          <div className="bg-white rounded-3xl shadow-soft p-12 text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#34D399] text-[#04352A] rounded-full text-sm font-bold hover:shadow-elevated"
            >
            ...
            {currentItems.slice(0, 6).map((item, i) => (
              ...
              >
                ...
                <div className="p-4 md:p-5">
                  <h3 className="font-black text-sm md:text-base text-gray-900 leading-snug line-clamp-3 mb-3 group-hover:text-[#059669] transition-colors">
                    {item.title}
                  </h3>
                  <div className="flex items-center justify-between text-[11px] text-gray-500 pt-2 border-t border-gray-100">
                    ...
                    <span className="inline-flex items-center gap-1 text-[#059669] font-bold group-hover:gap-2 transition-all">
                      اقرأ
