  ...
  return (
    <div className="bg-white rounded-3xl shadow-card p-6 space-y-4">
      <div>
        ...
        <p className="text-3xl font-black text-[#1F6F5F] tabular leading-tight">
      ...
      <div className="pt-3 border-t border-gray-100 flex items-center justify-between">
        ...
        <p className="text-xl font-black text-[#1F6F5F] tabular">
      ...
      <button
        ...
        className="w-full bg-[#1F6F5F] text-white py-3.5 rounded-2xl font-bold text-sm shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2"
      >
        {pending ? (
      ...
      <button
        ...
        className="w-full bg-white border-2 border-[#1F6F5F] text-[#1F6F5F] py-3 rounded-2xl font-bold text-sm hover:bg-[#1F6F5F]/5 transition-all flex items-center justify-center gap-2"
      >
        <ShoppingCart className="w-4 h-4" />
        {t('order.buy_now')}
      </button>
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-50 bg-white border-t border-gray-100 shadow-luxe lg:hidden">
      <div className="max-w-6xl mx-auto p-3 flex items-center gap-3">
        ...
        <button
          onClick={() => router.push('/cart')}
          className="bg-[#1F6F5F] text-white px-5 py-3 rounded-2xl font-bold text-sm shadow-elevated hover:-translate-y-0.5 transition-all flex items-center gap-2"
        >
          <ShoppingCart className="w-4 h-4" />
...
function QtyStepper({
  ...
  return (
    <div className="flex items-center gap-2 bg-[#FAFAF7] rounded-xl p-1">
      ...
      <button
        onClick={onInc}
        className="w-7 h-7 bg-[#1F6F5F] text-white rounded-lg flex items-center justify-center hover:bg-[#1F6F5F]/90 transition shadow-soft"
        type="button"
      >
