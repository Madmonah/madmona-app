    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-4 shadow-soft">
      <div className="flex items-start gap-3">
        <div className={`w-10 h-10 rounded-2xl flex items-center justify-center flex-shrink-0 ${
          status === 'subscribed' ? 'bg-[#34D399]/10 text-[#059669]' : 'bg-gray-100 text-gray-500'
        }`}>
          ...
          <div className="mt-3">
            {status === 'subscribed' ? (
              ...
              <button
                ...
                disabled={busy}
                className="text-xs font-bold text-[#04352A] bg-[#34D399] hover:bg-[#34D399]/90 px-4 py-2 rounded-xl flex items-center gap-1.5 disabled:opacity-50"
              >
