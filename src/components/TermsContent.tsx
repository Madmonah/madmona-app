        ...
        <article className="bg-white rounded-3xl shadow-card p-7 md:p-10 space-y-7 animate-slide-up delay-100">
          {en ? (
            ...
            <>
              ...
              <Section title="٨ مكرر. برنامج «شير واكسب» (الإحالات ورصيد المحفظة)">
                <ul>
                  <li>عن كل حساب جديد ينضم لمضمونة عن طريق كود الإحالة الخاص بك، تحصل على <strong>100 جنيه رصيدًا ترويجيًا</strong> في محفظتك.</li>
