    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">
      ...
      <section className="bg-white rounded-xl border border-gray-100 p-5 space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669]"
            disabled={mode === 'edit'}
          >
              ...
              return (
                <button
                  ...
                  className={`px-3 py-2.5 rounded-xl border text-sm font-medium transition-colors ${
                    selected
                      ? 'border-[#059669] bg-[#34D399] text-[#04352A]'
      ...
      <section className="bg-white rounded-xl border border-gray-100 p-5 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669] text-right resize-none"
            maxLength={1000}
          />
        </div>
        ...
        <label className="block">
          <div className={`flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed rounded-xl cursor-pointer transition-colors ${
            uploading
              ...
              : 'border-gray-300 bg-[#FAFAF7] text-gray-700 hover:border-[#059669] hover:bg-[#34D399]/5'
          }`}>
            {uploading ? (
              <>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30"
            >
      ...
      <div className="flex flex-col sm:flex-row gap-3 sticky bottom-4 bg-[#FAFAF7] py-3 border-t border-gray-200 -mx-4 px-4 sm:relative sm:bottom-auto sm:py-0 sm:border-0 sm:mx-0 sm:px-0">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-[#34D399] text-[#04352A] py-3 rounded-xl font-semibold hover:bg-[#34D399]/90 disabled:opacity-50"
        >
          {submitting ? (
            <Loader2 className="w-4 h-4 animate-spin" />
          ) : (
    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          placeholder="—"
          className="w-full px-3 py-2.5 pl-12 border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-[#059669]/30 focus:border-[#059669]"
        />
