...
export default function VerifyPhoneByCall({
  ...
  if (phase === 'done') {
    return (
      <div className="flex items-center justify-center gap-2 bg-[#2B4521]/10 text-[#2B4521] py-4 rounded-2xl font-bold">
  ...
  if (phase === 'calling') {
    return (
      <div className="bg-[#F0F7F4] border border-[#2FA084]/30 rounded-2xl p-4 text-center">
        <a
          href={`tel:${callNumber}`}
          className="w-full flex items-center justify-center gap-2 bg-[#2B4521] text-white py-4 rounded-2xl font-bold text-base shadow-elevated hover:-translate-y-0.5 transition-all mb-3"
        >
        ...
        <div dir="ltr" className="inline-block bg-white border border-[#2FA084]/40 rounded-xl px-5 py-2 font-black text-lg tracking-wider text-[#2B4521] mb-3 select-all">
          {callNumber}
        </div>
        ...
        {slow && (
          <button
            ...
            className="inline-flex items-center gap-1.5 text-xs font-bold text-[#2B4521] hover:underline mt-3"
          >
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className="w-full bg-[#2B4521] text-white py-4 rounded-2xl font-bold text-base shadow-elevated hover:shadow-luxe hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:translate-y-0 transition-all"
      >
        كمّل
      </button>
    </div>
