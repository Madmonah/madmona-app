...
.ag-dir .ag-card {
  ...
  border: 1px solid rgba(31,111,95,.15);
  border-radius: 18px;
  padding: 22px;
...
.ag-dir .ag-kicker { font-size: 10.5px; font-weight: 800; letter-spacing: .08em; color: #1F6F5F; margin-bottom: 4px; }
...
.ag-dir .ag-btn-edit {
  ...
  background: #1F6F5F; color: #fff; border: none; cursor: pointer; transition: .15s;
}
...
.ag-dir .ag-input:focus, .ag-dir .ag-textarea:focus { outline: 2px solid #1F6F5F; border-color: #1F6F5F; }
...
.ag-dir .ag-radio input { accent-color: #1F6F5F; }
...
.ag-dir .ag-btn-save { background: linear-gradient(120deg, #D4A017, #2FA084, #1F6F5F); color: #fff; }
.ag-dir .ag-btn-save:hover:not(:disabled) { transform: translateY(-1px); box-shadow: 0 8px 20px -8px rgba(31,111,95,.4); }
