  ...
  return (
    <section className="qhub-sec">
      ...
      <style jsx>{`
        ...
        .qhub-kicker{display:inline-flex;align-items:center;gap:8px;font-size:11px;font-weight:800;letter-spacing:.08em;color:#059669;margin-bottom:6px}
        .qhub-kicker::before{content:"";width:6px;height:6px;border-radius:50%;background:linear-gradient(118deg,#D4A017,#2FA084,#059669)}
        ...
        .qhub-loading{width:18px;height:18px;border-radius:50%;border:2.5px solid #E7F1ED;border-top-color:#059669;animation:qhsp 1s linear infinite}
        ...
        .qhub-tile::before{
          ...
          background:var(--ax,#059669);border-start-end-radius:18px;border-end-end-radius:18px;
          opacity:.85;transition:width .22s;
        }
        .qhub-tile:hover{transform:translateY(-4px);box-shadow:0 22px 50px -22px rgba(16,40,34,.28);border-color:var(--ax,#059669)}
        ...
        .qhub-stat b{font-size:18px;font-weight:700;color:var(--ax,#059669);font-family:var(--font-inter),system-ui,sans-serif}
        ...
        .qhub-tile:hover .qhub-arrow{opacity:1;color:var(--ax,#059669);transform:translateX(-3px)}

        /* accent palette per tile */
        .a-green   { --ax:#059669; --bg:linear-gradient(135deg,#E7F1ED,#F3F1EA) }
