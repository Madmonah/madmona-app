...
export default function BookingToast({ visible, bookingId, onDismiss }: BookingToastProps) {
  ...
  return (
    ...
    >
      <Link
        href={href}
        className="block bg-white border border-[#1F6F5F]/20 rounded-2xl shadow-lg p-4 hover:shadow-xl no-underline"
      >
        <div className="flex items-start gap-3">
          <div className="w-10 h-10 bg-[#1F6F5F]/10 rounded-full flex items-center justify-center flex-shrink-0 animate-pulse">
