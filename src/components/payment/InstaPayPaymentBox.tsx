...
export default function InstaPayPaymentBox({
  ...
  return (
    <div className="my-6 rounded-2xl bg-white border-2 border-[#2B4521]/20 p-5 shadow-sm">
      {/* Header */}
      <div className="flex items-center gap-3 mb-4">
        <div className="w-12 h-12 rounded-xl bg-[#2B4521]/10 flex items-center justify-center text-2xl">
          🏦
        </div>
      ...
      {amount !== undefined && amount > 0 && (
        <div className="mb-4 p-4 rounded-xl bg-gradient-to-l from-[#2B4521]/8 to-[#2B4521]/4 border border-[#2B4521]/20">
          <div className="text-xs text-gray-600 mb-1">المبلغ المطلوب</div>
          <div className="text-2xl font-bold text-[#2B4521]">
          ...
          {reference && (
            <div className="mt-2 text-xs text-gray-500">
              ...
              <button
                ...
                className="ms-2 text-[#2B4521] hover:underline"
              >
      ...
      {config.payment_link && (
        <a
          ...
          className="block w-full text-center py-3.5 rounded-xl bg-[#2B4521] text-white font-bold text-base hover:bg-[#2B4521]/90 transition-colors mb-3"
        >
        ...
        {config.account_number && (
          <div className="flex items-start justify-between gap-3 p-3 rounded-lg bg-gray-50 border border-gray-200">
            ...
            <button
              ...
              className="flex-shrink-0 px-3 py-1.5 rounded-lg bg-white border border-[#2B4521]/30 text-xs font-bold text-[#2B4521] hover:bg-[#2B4521]/5"
            >
