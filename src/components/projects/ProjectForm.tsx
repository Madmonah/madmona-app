...
export default function ProjectForm({
    ...
    return (
      <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <a href="https://wa.me/201002229982" className="text-[#1F6F5F] font-bold hover:underline">
            01002229982
          </a>
        </p>
      </div>
  ...
  const inputCls =
    'w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1F6F5F]/25 focus:border-[#1F6F5F]'
  ...
  return (
    <form onSubmit={submit} dir="rtl" className="space-y-4">
      ...
      <button
        type="submit"
        disabled={busy}
        className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-[#1F6F5F] text-white font-bold text-sm disabled:opacity-60 hover:opacity-95 transition-opacity"
      >
