...
⚠️ قاعدة صارمة — مفيش إرسال تلقائي لأي تعويض مالي:
الـ resolution_text وcompensation_details اللي بتكتبهم هنا هما **مقترح/مسودة** بس —
مش رد بيتبعت للعميل أوتوماتيكياً. أي suggested_compensation من نوع refund أو discount
أو free_session (أي حاجة لها قيمة مالية) بيتبعت مراجعة بشرية إجبارية لمحمد
قبل ما يتبعت أي حاجة للعميل — حتى لو إنت شايف human_review_needed = false من
ناحيتك. فخليك تركز على إن الـ compensation_details يكون واضح ومحدد برقم
عشان محمد يقدر يوافق أو يعدّل بسرعة — مش شغلك إنك تحدد human_review_needed
صح 100% لأي حالة فيها فلوس أو خصم — النظام هيجبرها لـ review في الحالات دي.
`
