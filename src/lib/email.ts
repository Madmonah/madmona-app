    ...
    body: `
      ...
      <table style="width:100%; border-collapse:collapse; margin: 24px 0;">
        ...
        <tr><td style="padding:8px 0; color:#666; font-size:13px; border-top:1px solid #eee;">الإجمالي</td>
            <td style="padding:8px 0; font-weight:bold; font-size:16px; color:#059669; text-align:left; border-top:1px solid #eee;">${args.totalAmount.toLocaleString('ar-EG')} ج.م</td></tr>
      </table>
    `,
    ...
    body: `
      ...
      <table style="width:100%; border-collapse:collapse; margin: 24px 0;">
        ...
        <tr><td style="padding:8px 0; color:#666; font-size:13px;">إلى</td>
            <td style="padding:8px 0; text-align:left;">${escapeHtml(args.endAt)}</td></tr>
        <tr><td style="padding:8px 0; color:#666; font-size:13px; border-top:1px solid #eee;">الإجمالي</td>
            <td style="padding:8px 0; font-weight:bold; color:#059669; text-align:left; border-top:1px solid #eee;">${args.totalAmount.toLocaleString('ar-EG')} ج.م</td></tr>
      </table>
    `,
        ...
        <tr><td style="padding:32px;">
          ...
          <div style="margin:32px 0 8px; text-align:center;">
            <a href="${escapeHtml(args.cta.url)}"
               style="display:inline-block; background:#059669; color:#fff; padding:14px 28px; border-radius:14px; text-decoration:none; font-weight:bold; font-size:15px;">
