    ...
    body: `
      ...
      <table style="width:100%; border-collapse:collapse; margin: 24px 0;">
        ...
        <tr><td style="padding:8px 0; color:#666; font-size:13px; border-top:1px solid #eee;">الإجمالي</td>
            <td style="padding:8px 0; font-weight:bold; font-size:16px; color:#2B4521; text-align:left; border-top:1px solid #eee;">${args.totalAmount.toLocaleString('ar-EG')} ج.م</td></tr>
      </table>
    `,
    ...
    body: `
      ...
      <table style="width:100%; border-collapse:collapse; margin: 24px 0;">
        ...
        <tr><td style="padding:8px 0; color:#666; font-size:13px;">إلى</td>
            <td style="padding:8px 0; text-align:left;">${escapeHtml(args.endAt)}</td></tr>
        <tr><td style="padding:8px 0; color:#666; font-size:13px; border-top:1px solid #eee;">الإجمالي</td>
            <td style="padding:8px 0; font-weight:bold; color:#2B4521; text-align:left; border-top:1px solid #eee;">${args.totalAmount.toLocaleString('ar-EG')} ج.م</td></tr>
      </table>
    `,
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#FAFAF7; padding:40px 20px;">
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; background:#fff; border-radius:24px; overflow:hidden; box-shadow:0 4px 16px rgba(0,0,0,0.04);">
        <tr><td style="padding:32px 32px 16px; text-align:center; background: linear-gradient(135deg, #2B4521 0%, #5A6E3A 100%); color:#fff;">
        ...
        <tr><td style="padding:32px;">
          ...
          <div style="margin:32px 0 8px; text-align:center;">
            <a href="${escapeHtml(args.cta.url)}"
               style="display:inline-block; background:#2B4521; color:#fff; padding:14px 28px; border-radius:14px; text-decoration:none; font-weight:bold; font-size:15px;">
        ...
        <tr><td style="padding:24px 32px; background:#FAFAF7; text-align:center; font-size:11px; color:#999;">
          ...
          <p style="margin:8px 0 0;">
            <a href="https://wa.me/201002229982" style="color:#2B4521; text-decoration:none;">واتساب: +20 100 222 9982</a>
          </p>
        </td></tr>
      </table>
    </td></tr>
