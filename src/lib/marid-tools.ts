...
export const MARID_TOOLS = [
  {
    name: 'search_catalog',
    description:
      'ابحث في إعلانات مضمونة الحقيقية. **استخدمها فورًا** كل مرة العميل يسأل عن ' +
      'أي حاجة (شقة، فيلا، عربية، مطعم، شاليه، محل، خدمة...) — من غير ما تسأله أسئلة كتير الأول. ' +
      '⚠️ مرّر **المنطقة في city** لو ذكرها (مدينة نصر، التجمع، الساحل...) — ده بيفلتر النتايج بدقة. ' +
      'كل نتيجة فيها exact_match: لو true يبقى تطابق حقيقي للنوع اللي طلبه؛ ' +
      'لو false يبقى دي حاجة في نفس المنطقة بس نوعها مختلف — **ماتعرضهاش على إنها اللي طلبه**. ' +
      'لو رجعت صفر: قول للعميل بصراحة إنه مش متاح دلوقتي، **وسجّل طلبه** بـrecord_unmet_demand ' +
      'وقوله هترجعله أول ما يتوفر. ممنوع تخترع إعلانات أو أسعار.',
    input_schema: {
