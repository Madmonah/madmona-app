...
.gradient-hero { background: linear-gradient(160deg, #0F3220 0%, #1F5F3F 45%, #2d7a52 100%); }
...
.gold-line { background: linear-gradient(90deg, transparent, #B8860B, transparent); }
...
<div class="absolute top-0 right-0 w-64 h-64 bg-[#B8860B] opacity-10 rounded-full blur-3xl"></div>
<div class="absolute bottom-0 left-0 w-64 h-64 bg-[#B8860B] opacity-5 rounded-full blur-3xl"></div>
<div class="max-w-lg mx-auto px-5 py-10 relative">
<div class="inline-flex items-center gap-2 bg-[#B8860B]/20 backdrop-blur border border-[#B8860B]/40 px-3 py-1.5 rounded-full mb-4">
<span class="text-xs">💒</span>
<span class="text-xs font-black tracking-widest text-[#d4a017]">FOR HALL OWNERS</span>
</div>
<h1 class="text-3xl md:text-4xl font-black leading-tight text-balance mb-3">
صاحب قاعة أفراح؟<br>
<span class="text-[#d4a017]">عرسانك القادمين على بعد كليكة.</span>
</h1>
<p class="text-base opacity-95 leading-relaxed mb-5">
منصة مضمونة بتجيب لقاعتك عرسان موثوقين بدفع مقدم محمي، عمولة 10٪ بس، وأول 30 يوم بـ <span class="font-black text-[#d4a017]">0٪ عمولة</span> تجربة.
</p>
...
<p class="text-[10px] font-black text-[#B8860B] uppercase tracking-[0.3em] mb-2">المشكلة اللي بنحلها</p>
...
<p class="text-xs font-black text-[#1F5F3F] mb-1">✓ مع مضمونة</p>
...
<div class="gold-line h-px my-3"></div>
<p class="text-xs font-black text-[#1F5F3F] mb-1">✓ مع مضمونة</p>
<p class="text-sm text-gray-700">عمولة 10٪ بس، و<span class="font-black text-[#B8860B]">صفر عمولة لأول 30 يوم</span>. كله شفاف، فلوسك تتحول لحسابك مباشرة.</p>
</div>
</div>
...
<section class="max-w-lg mx-auto px-5 py-8">
<div class="text-center mb-5">
<p class="text-[10px] font-black text-[#B8860B] uppercase tracking-[0.3em] mb-2">إزاي بنشتغل</p>
...
<div class="w-9 h-9 bg-[#1F5F3F] text-white rounded-lg flex items-center justify-center font-black text-sm flex-shrink-0">١</div>
<div class="flex-1">
...
<div class="bg-white rounded-xl p-4 flex items-center gap-3 shadow-sm border border-gray-100">
<div class="w-9 h-9 bg-[#1F5F3F] text-white rounded-lg flex items-center justify-center font-black text-sm flex-shrink-0">٢</div>
<div class="flex-1">
...
<div class="bg-white rounded-xl p-4 flex items-center gap-3 shadow-sm border border-gray-100">
<div class="w-9 h-9 bg-[#1F5F3F] text-white rounded-lg flex items-center justify-center font-black text-sm flex-shrink-0">٣</div>
<div class="flex-1">
...
<div class="bg-white rounded-xl p-4 flex items-center gap-3 shadow-sm border border-gray-100">
<div class="w-9 h-9 bg-[#B8860B] text-white rounded-lg flex items-center justify-center font-black text-sm flex-shrink-0">٤</div>
<div class="flex-1">
...
<p class="text-[10px] font-black text-[#d4a017] uppercase tracking-[0.3em] mb-2">ليه مضمونة؟</p>
...
<a href="https://www.instagram.com/madmona.cairo" class="text-gray-500 hover:text-[#1F5F3F]">Instagram</a>
<span class="text-gray-300">·</span>
<a href="https://www.facebook.com/MadmonaCairo" class="text-gray-500 hover:text-[#1F5F3F]">Facebook</a>
<span class="text-gray-300">·</span>
<a href="https://madmonacairo.com" class="text-gray-500 hover:text-[#1F5F3F]">الموقع</a>
</div>
