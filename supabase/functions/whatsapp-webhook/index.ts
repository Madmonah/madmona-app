...
async function generateReply(
  ...
  const commissionLine = await getCfg('commission_line_restaurants_prompt', 'Commission: 10% individuals / 5% companies / restaurants & cafes FREE (0%) for a LIMITED TIME — always frame as «عرض لفترة محدودة», never as permanent')
